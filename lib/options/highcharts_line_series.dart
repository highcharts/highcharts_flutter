...
import 'highcharts_line_series_data_options.dart';
...
export 'highcharts_line_series_data_options.dart';
...
/// {@category series}
class HighchartsLineSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.name
  String? name;

  /// Configuration options for the HighchartsLineSeries.
  HighchartsLineSeriesOptions? options;

  /// List of data point objects for the HighchartsLineSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsLineSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsLineSeriesDataOptions>? dataPoints;
  @override
  get type => 'line';
