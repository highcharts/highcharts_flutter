...
class HighchartsXRangeSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.data.events.update
