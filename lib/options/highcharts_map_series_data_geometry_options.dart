...
class HighchartsMapSeriesDataGeometryOptions extends HighchartsOptionsBase {
  ...
  /// `type`.
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.map.data.geometry.coordinates
  ...
  /// or `MultiPolygon`.
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.map.data.geometry.type
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.map.data.geometry
  HighchartsMapSeriesDataGeometryOptions({this.coordinates, this.type});
