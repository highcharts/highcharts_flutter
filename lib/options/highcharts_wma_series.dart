...
class HighchartsWMASeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wma.name
  String? name;

  /// Configuration options for the HighchartsWMASeries.
  HighchartsWMASeriesOptions? options;

  /// List of data point objects for the HighchartsWMASeries series.
  ///
