...
import 'highcharts_variwide_series_data_options.dart';
...
export 'highcharts_variwide_series_data_options.dart';
...
class HighchartsVariwideSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.name
  String? name;

  /// Configuration options for the HighchartsVariwideSeries.
  HighchartsVariwideSeriesOptions? options;

  /// List of data point objects for the HighchartsVariwideSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsVariwideSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsVariwideSeriesDataOptions>? dataPoints;
  @override
  get type => 'variwide';
