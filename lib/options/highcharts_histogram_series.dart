...
class HighchartsHistogramSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.histogram.name
  String? name;

  /// Configuration options for the HighchartsHistogramSeries.
  HighchartsHistogramSeriesOptions? options;

  /// List of data point objects for the HighchartsHistogramSeries series.
  ///
