...
class HighchartsTreegraphSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.data.events.drop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.data.events
  HighchartsTreegraphSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
