...
class HighchartsHistogramSeriesStatesSelectOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.histogram.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.histogram.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.histogram.states.select.enabled
