...
class HighchartsScatterSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter.data.events
  HighchartsScatterSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
