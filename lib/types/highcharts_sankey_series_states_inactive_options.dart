...
class HighchartsSankeySeriesStatesInactiveOptions
    extends HighchartsOptionsBase {
  /// Animation when not hovering over the marker.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.states.inactive.animation

  HighchartsSeriesStatesInactiveAnimationOptions? animation;

  /// Enable or disable the inactive state for a series
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.states.inactive.enabled
  ...
  /// inactive mode.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.states.inactive.linkOpacity

  double? linkOpacity;

  /// Opacity of the nodes in the sankey diagram in inactive mode.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.states.inactive.opacity
