...
class HighchartsItemSeriesDataLabelsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.alignTo
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.backgroundColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.borderColor

  String? borderColor;

  /// The border radius in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.borderRadius

  double? borderRadius;

  /// The border width in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.borderWidth
  ...
  /// shadow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.connectorColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.connectorPadding
  ...
  /// the example).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.connectorShape
  ...
  /// `.highcharts-data-label-connector` class.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.connectorWidth
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.crookDistance
  ...
  /// option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.crop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.defer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.distance
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.filter
  ...
  /// `formatter`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.format
  ...
  /// points, like `pie`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.overflow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.padding
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.position
  ...
  /// rotated data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.rotation
  ...
  /// and `width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.shadow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.shape
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.softConnector
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.textPath
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.useHTML
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.verticalAlign
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.x
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.y
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.dataLabels.zIndex

  double? zIndex;

  /// Highcharts Options Widget.
  HighchartsItemSeriesDataLabelsOptions(
      {this.alignTo,
      this.animation,
