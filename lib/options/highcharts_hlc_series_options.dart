...
import 'highcharts_hlc_series_data_grouping_options.dart';
import 'highcharts_hlc_series_data_labels_options.dart';
import 'highcharts_series_data_sorting_options.dart';
import 'highcharts_hlc_series_drag_drop_options.dart';
...
import 'highcharts_hlc_series_states_options.dart';
import 'highcharts_hlc_series_tooltip_options.dart';
...
export 'highcharts_hlc_series_data_grouping_options.dart';
export 'highcharts_hlc_series_data_labels_options.dart';
export 'highcharts_series_data_sorting_options.dart';
export 'highcharts_hlc_series_drag_drop_options.dart';
...
export 'highcharts_hlc_series_states_options.dart';
export 'highcharts_hlc_series_tooltip_options.dart';
...
class HighchartsHLCSeriesOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.allowPointSelect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.animationLimit

  double? animationLimit;

  /// Sets the color blending in the boost module.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.boostBlending
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.boostThreshold
  ...
  /// missing points.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.centerInCategory
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.clip
  ...
  /// `className` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.colorAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.colorByPoint
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.colorIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.colors
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.hlc.compare
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.hlc.compareBase
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.hlc.compareStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.cropThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.hlc.cumulative
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.hlc.cumulativeStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.cursor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.custom
  ...
  /// series.color.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dashStyle
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataSorting
  ...
  /// about the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.enableMouseTracking
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.findNearestPointBy
  ...
  /// series only.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.getExtremesFromAll

  bool? getExtremesFromAll;

  /// Padding between each value groups, in x axis units.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.groupPadding
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.grouping
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.id
  ...
  /// with large datasets.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.inactiveOtherPoints
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.includeInDataExport
  ...
  /// legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.index
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.keys
  ...
  /// `graph` or an `area`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.label

  HighchartsSeriesLabelOptions? label;

  /// The line marks the last price from all points.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.hlc.lastPrice

  HighchartsSeriesLastPriceOptions? lastPrice;

  /// The line marks the last price from visible range of points.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.hlc.lastVisiblePrice

  HighchartsSeriesLastVisiblePriceOptions? lastVisiblePrice;

  /// The sequential index of the series in the legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.legendIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.legendSymbol
  ...
  /// styled mode.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.legendSymbolColor

  String? legendSymbolColor;

  /// The pixel width of the line/border. Defaults to `1`.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.hlc.lineWidth
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.linkedTo
  ...
  /// chart.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.maxPointWidth
  ...
  /// packed values.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.minPointLength
  ...
  /// defined both places.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.hlc.navigatorOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.negativeColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.nullInteraction
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.onPoint

  HighchartsSeriesOnPointOptions? onPoint;

  /// Opacity of a series parts: line, fill (e.g. area) and dataLabels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.opacity

  double? opacity;

  /// Properties for each single point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.point
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.pointDescriptionFormat
  ...
  /// but for an individual series. Overrides the chart wide configuration.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.pointDescriptionFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.pointInterval
  ...
  /// interval of the axis ticks, which is independent.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.pointIntervalUnit

  String? pointIntervalUnit;

  /// Padding between each column or bar, in x axis units.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.pointPadding
  ...
  /// charts.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.pointPlacement
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.pointRange
  ...
  /// value.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.pointStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.pointWidth
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.relativeXValue
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.selected
  ...
  /// whole series group.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.shadow
  ...
  /// the `selected` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.showCheckbox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.showInLegend
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.hlc.showInNavigator
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.skipKeyboardNavigation
  ...
  /// at 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.softThreshold

  bool? softThreshold;

  /// Sonification/audio chart options for a series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.sonification
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.stack
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.turboThreshold

  double? turboThreshold;

  /// Set the initial visibility of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.visible
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.xAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.yAxis

  dynamic yAxis;

  /// Define the visual z index of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.zIndex

  double? zIndex;

  /// Defines the Axis on which the zones are applied.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.zoneAxis
  ...
  /// (view live demo).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.zones
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.zoomEnabled
