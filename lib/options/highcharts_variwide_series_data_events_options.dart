...
class HighchartsVariwideSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.data.events
  HighchartsVariwideSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
