...
import 'highcharts_area_series_data_options.dart';
...
export 'highcharts_area_series_data_options.dart';
...
class HighchartsAreaSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.name
  String? name;

  /// Configuration options for the HighchartsAreaSeries.
  HighchartsAreaSeriesOptions? options;

  /// List of data point objects for the HighchartsAreaSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsAreaSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsAreaSeriesDataOptions>? dataPoints;
  @override
  get type => 'area';
