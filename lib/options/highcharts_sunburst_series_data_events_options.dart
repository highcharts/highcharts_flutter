...
class HighchartsSunburstSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.data.events
  HighchartsSunburstSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
