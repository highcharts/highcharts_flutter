...
class HighchartsHLCSeriesStatesSelectOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.states.select.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.states.select
  HighchartsHLCSeriesStatesSelectOptions(
