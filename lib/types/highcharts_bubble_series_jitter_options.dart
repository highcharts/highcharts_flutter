...
class HighchartsBubbleSeriesJitterOptions extends HighchartsOptionsBase {
  /// The maximal X offset for the random jitter effect.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.jitter.x

  double? x;

  /// The maximal Y offset for the random jitter effect.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.jitter.y
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.jitter
  HighchartsBubbleSeriesJitterOptions({this.x, this.y});
