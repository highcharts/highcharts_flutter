...
import 'highcharts_hollowcandlestick_series_data_options.dart';
...
export 'highcharts_hollowcandlestick_series_data_options.dart';
...
class HighchartsHollowcandlestickSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.name
  String? name;

  /// Configuration options for the HighchartsHollowcandlestickSeries.
  HighchartsHollowcandlestickSeriesOptions? options;

  /// List of data point objects for the HighchartsHollowcandlestickSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsHollowcandlestickSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsHollowcandlestickSeriesDataOptions>? dataPoints;
  @override
