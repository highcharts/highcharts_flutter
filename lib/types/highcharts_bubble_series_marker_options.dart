...
class HighchartsBubbleSeriesMarkerOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.marker.fillColor

  String? fillColor;

  /// The fill opacity of the bubble markers.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.marker.fillOpacity
