...
import 'highcharts_column_series_data_options.dart';
...
export 'highcharts_column_series_data_options.dart';
...
class HighchartsColumnSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.name
  String? name;

  /// Configuration options for the HighchartsColumnSeries.
  HighchartsColumnSeriesOptions? options;

  /// List of data point objects for the HighchartsColumnSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsColumnSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsColumnSeriesDataOptions>? dataPoints;
  @override
  get type => 'column';
