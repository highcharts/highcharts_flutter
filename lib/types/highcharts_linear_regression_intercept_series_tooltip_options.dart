...
class HighchartsLinearRegressionInterceptSeriesTooltipOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.linearregressionintercept.tooltip.changeDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.dateTimeLabelFormats

  HighchartsTooltipDateTimeLabelFormatsOptions? dateTimeLabelFormats;

  /// Distance from point to tooltip in pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.distance
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.headerFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.nullFormatter
  ...
  /// point color.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.pointFormat
  ...
  /// flexibility.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.pointFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.position
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.tooltip.xDateFormat

  String? xDateFormat;

  /// Highcharts Options Widget.
  HighchartsLinearRegressionInterceptSeriesTooltipOptions(
      {this.changeDecimals,
      this.clusterFormat,
