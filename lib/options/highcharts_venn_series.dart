...
import 'highcharts_venn_series_data_options.dart';
...
export 'highcharts_venn_series_data_options.dart';
...
class HighchartsVennSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.venn.name
  String? name;

  /// Configuration options for the HighchartsVennSeries.
  HighchartsVennSeriesOptions? options;

  /// List of data point objects for the HighchartsVennSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsVennSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsVennSeriesDataOptions>? dataPoints;
  @override
  get type => 'venn';
