...
class HighchartsAOSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ao.name
  String? name;

  /// Configuration options for the HighchartsAOSeries.
  HighchartsAOSeriesOptions? options;

  /// List of data point objects for the HighchartsAOSeries series.
  ///
