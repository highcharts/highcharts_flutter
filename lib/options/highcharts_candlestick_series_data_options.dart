...
class HighchartsCandlestickSeriesDataOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.accessibility

  HighchartsCandlestickSeriesDataAccessibilityOptions? accessibility;

  /// The closing value of each data point.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.candlestick.data.close
  ...
  /// `colorIndex`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.color
  ...
  /// callbacks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.custom
  ...
  /// about the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.events

  HighchartsCandlestickSeriesDataEventsOptions? events;

  /// The high or maximum value for each data point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.high
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.id
  ...
  /// will be drawn.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.labelrank

  double? labelrank;

  /// The low or minimum value for each data point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.low

  double? low;

  /// The name of the point as shown in the legend, tooltip, dataLabels, etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.name

  String? name;

  /// The opening value of each data point.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.candlestick.data.open

  double? open;

  /// Whether the data point is selected initially.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.selected
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.x
