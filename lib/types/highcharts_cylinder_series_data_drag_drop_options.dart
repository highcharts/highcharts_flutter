...
class HighchartsCylinderSeriesDataDragDropOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.dragHandle

  HighchartsSeriesDragDropDragHandleOptions? dragHandle;

  /// Set the maximum X value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.dragMaxX

  dynamic dragMaxX;

  /// Set the maximum Y value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.dragMaxY

  double? dragMaxY;

  /// Set the minimum X value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.dragMinX

  dynamic dragMinX;

  /// Set the minimum Y value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.dragMinY
  ...
  /// `1`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.dragPrecisionX
  ...
  /// `1`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.dragPrecisionY
  ...
  /// selecting points.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.dragSensitivity

  double? dragSensitivity;

  /// Enable dragging in the X dimension.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.draggableX
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.draggableY
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.groupBy
  ...
  /// the `default` state.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.guideBox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.dragDrop.liveRedraw
