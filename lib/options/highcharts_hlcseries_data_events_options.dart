...
class HighchartsHLCSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.data.events
  HighchartsHLCSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
