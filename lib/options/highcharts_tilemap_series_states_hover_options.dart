...
class HighchartsTilemapSeriesStatesHoverOptions extends HighchartsOptionsBase {
  ...
  /// rule.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.tilemap.states.hover.brightness

  double? brightness;

  /// Animation setting for hovering the graph in line-type series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.tilemap.states.hover.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.tilemap.states.hover.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.tilemap.states.hover.lineWidth

  double? lineWidth;

  /// The additional line width for the graph of a hovered series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.tilemap.states.hover.lineWidthPlus
  ...
  /// marker.states.hover.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.tilemap.states.hover.marker
