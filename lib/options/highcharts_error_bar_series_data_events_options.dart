...
class HighchartsErrorBarSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.events
  HighchartsErrorBarSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
