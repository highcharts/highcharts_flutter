...
class HighchartsAreaSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.events
  HighchartsAreaSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
