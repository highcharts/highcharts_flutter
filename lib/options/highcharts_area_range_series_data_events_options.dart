...
class HighchartsAreaRangeSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.data.events
  HighchartsAreaRangeSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
