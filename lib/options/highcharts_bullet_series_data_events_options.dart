...
class HighchartsBulletSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bullet.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bullet.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bullet.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bullet.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bullet.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bullet.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bullet.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bullet.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bullet.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bullet.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bullet.data.events
  HighchartsBulletSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
