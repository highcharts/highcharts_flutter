...
class HighchartsMACDSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.macd.name
  String? name;

  /// Configuration options for the HighchartsMACDSeries.
  HighchartsMACDSeriesOptions? options;

  /// List of data point objects for the HighchartsMACDSeries series.
  ///
