...
class StochasticIndicator extends OptionFragment {
  ...
  void toJSONInner(StringBuffer buffer) {
    ...
    // NOTE: skip serialization of pointArrayMap (type (keyof StochasticPoint)[] is ignored) ignore type: true

    // NOTE: skip serialization of pointClass (type typeof StochasticPoint is ignored) ignore type: true
