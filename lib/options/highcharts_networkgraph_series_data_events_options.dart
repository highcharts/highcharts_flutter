...
class HighchartsNetworkgraphSeriesDataEventsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.networkgraph.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.networkgraph.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.networkgraph.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.networkgraph.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.networkgraph.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.networkgraph.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.networkgraph.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.networkgraph.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.networkgraph.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.networkgraph.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.networkgraph.data.events
  HighchartsNetworkgraphSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
