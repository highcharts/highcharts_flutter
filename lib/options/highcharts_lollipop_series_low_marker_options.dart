...
class HighchartsLollipopSeriesLowMarkerOptions extends HighchartsOptionsBase {
  ...
  /// data points.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.lowMarker.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.lowMarker.enabledThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.lowMarker.fillColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.lowMarker.height
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.lowMarker.lineColor

  String? lineColor;

  /// The width of the point marker's outline.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.lowMarker.lineWidth

  double? lineWidth;

  /// The radius of the point marker.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.lowMarker.radius

  double? radius;

  /// States for a single point marker.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.lowMarker.states
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.lowMarker.width
