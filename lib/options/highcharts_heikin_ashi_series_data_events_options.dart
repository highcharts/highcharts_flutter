...
class HighchartsHeikinAshiSeriesDataEventsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.data.events
  HighchartsHeikinAshiSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
