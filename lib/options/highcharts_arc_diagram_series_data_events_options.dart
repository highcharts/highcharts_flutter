...
class HighchartsArcDiagramSeriesDataEventsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.data.events
  HighchartsArcDiagramSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
