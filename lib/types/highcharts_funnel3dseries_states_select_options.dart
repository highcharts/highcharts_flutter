...
class HighchartsFunnel3DSeriesStatesSelectOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.states.select.enabled
