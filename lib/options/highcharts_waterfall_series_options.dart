...
class HighchartsWaterfallSeriesOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.allowPointSelect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.animationLimit
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.borderColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.borderRadius
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.borderWidth
  ...
  /// missing points.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.centerInCategory
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.clip
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.colorAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.colorByPoint
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.colorIndex
  ...
  /// is set to `'sum'`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.colorKey
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.colors
  ...
  /// is rendered blurry.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.crisp
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.cropThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.cursor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.custom
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.dataSorting

  HighchartsSeriesDataSortingOptions? dataSorting;

  /// Depth of the columns in a 3D column chart.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.depth
  ...
  /// about the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.edgeColor

  String? edgeColor;

  /// 3D columns only. The width of the colored edges.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.edgeWidth
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.enableMouseTracking
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.findNearestPointBy
  ...
  /// series only.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.getExtremesFromAll

  bool? getExtremesFromAll;

  /// Padding between each value groups, in x axis units.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.groupPadding

  double? groupPadding;

  /// The spacing between columns on the Z Axis in a 3D chart.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.groupZPadding
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.grouping
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.id
  ...
  /// with large datasets.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.inactiveOtherPoints
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.includeInDataExport
  ...
  /// legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.index
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.keys
  ...
  /// `graph` or an `area`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.label

  HighchartsSeriesLabelOptions? label;

  /// The sequential index of the series in the legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.legendIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.legendSymbol
  ...
  /// styled mode.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.legendSymbolColor
  ...
  /// class.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.lineColor

  String? lineColor;

  /// The width of the line connecting waterfall columns.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.lineWidth
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.linkedTo
  ...
  /// chart.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.maxPointWidth
  ...
  /// packed values.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.minPointLength
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.negativeColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.nullInteraction
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.onPoint

  HighchartsSeriesOnPointOptions? onPoint;

  /// Opacity of a series parts: line, fill (e.g. area) and dataLabels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.opacity

  double? opacity;

  /// Properties for each single point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.point
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.pointDescriptionFormat
  ...
  /// but for an individual series. Overrides the chart wide configuration.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.pointDescriptionFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.pointInterval
  ...
  /// interval of the axis ticks, which is independent.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.pointIntervalUnit

  String? pointIntervalUnit;

  /// Padding between each column or bar, in x axis units.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.pointPadding
  ...
  /// charts.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.pointPlacement
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.pointRange
  ...
  /// value.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.pointStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.pointWidth
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.relativeXValue
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.selected
  ...
  /// whole series group.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.shadow
  ...
  /// the `selected` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.showCheckbox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.showInLegend
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.skipKeyboardNavigation
  ...
  /// at 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.softThreshold

  bool? softThreshold;

  /// Sonification/audio chart options for a series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.sonification
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.stack
  ...
  /// series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.stacking
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.threshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.turboThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.upColor

  String? upColor;

  /// Set the initial visibility of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.visible
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.xAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.yAxis

  dynamic yAxis;

  /// Define the visual z index of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.zIndex

  double? zIndex;

  /// Defines the Axis on which the zones are applied.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.zoneAxis
  ...
  /// (view live demo).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.zones
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.zoomEnabled
