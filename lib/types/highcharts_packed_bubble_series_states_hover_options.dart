...
class HighchartsPackedBubbleSeriesStatesHoverOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.states.hover.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.states.hover.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.states.hover.lineWidth

  double? lineWidth;

  /// The additional line width for the graph of a hovered series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.states.hover.lineWidthPlus
  ...
  /// marker.states.hover.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.states.hover.marker
