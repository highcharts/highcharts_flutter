...
class HighchartsHeikinAshiSeriesStatesSelectOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.states.select.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heikinashi.states.select
  HighchartsHeikinAshiSeriesStatesSelectOptions(
