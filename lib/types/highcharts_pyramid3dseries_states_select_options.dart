...
class HighchartsPyramid3DSeriesStatesSelectOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.states.select.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.states.select
  HighchartsPyramid3DSeriesStatesSelectOptions(
