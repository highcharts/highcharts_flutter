...
class HighchartsLinearregressionslopeSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.name
  String? name;

  /// Configuration options for the HighchartsLinearregressionslopeSeries.
  HighchartsLinearregressionslopeSeriesOptions? options;

  /// List of data point objects for the HighchartsLinearregressionslopeSeries series.
  ///
