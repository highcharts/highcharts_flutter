...
class HighchartsWindbarbSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.events
  HighchartsWindbarbSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
