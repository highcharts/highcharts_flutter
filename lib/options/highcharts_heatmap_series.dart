...
import 'highcharts_heatmap_series_data_options.dart';
...
export 'highcharts_heatmap_series_data_options.dart';
...
class HighchartsHeatmapSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsHeatmapSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsHeatmapSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsHeatmapSeriesDataOptions>? dataPoints;
  @override
  get type => 'heatmap';
