...
class HighchartsOHLCSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.data.events
  HighchartsOHLCSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
