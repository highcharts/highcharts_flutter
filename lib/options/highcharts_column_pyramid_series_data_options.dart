...
class HighchartsColumnPyramidSeriesDataOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.className
  ...
  /// `colorIndex`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.colorIndex
  ...
  /// callbacks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.custom
  ...
  /// about the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.drilldown

  String? drilldown;

  /// The individual point events.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.id
  ...
  /// will be drawn.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.labelrank

  double? labelrank;

  /// The name of the point as shown in the legend, tooltip, dataLabels, etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.name

  String? name;

  /// Whether the data point is selected initially.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.selected
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.x

  dynamic x;

  /// The y value of the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data.y

  double? y;

  /// An array of data points for the series. For the `columnpyramid` series type, points can be given in the following ways:
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.data
