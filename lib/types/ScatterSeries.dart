...
class ScatterSeries extends Series {
  ...
  void toJSONInner(StringBuffer buffer) {
    ...
    if (this.options?.findNearestPointBy != null) {
        buffer.writeAll(["\"findNearestPointBy\":\'",this.options?.findNearestPointBy, "\',"], "");
    }
    
    if (this.options?.jitter != null) {
        buffer.writeAll(["\"jitter\":",this.options?.jitter?.toJSON(), ","], "");
    }
