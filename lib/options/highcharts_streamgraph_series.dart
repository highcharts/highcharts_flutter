...
import 'highcharts_streamgraph_series_data_options.dart';
...
export 'highcharts_streamgraph_series_data_options.dart';
...
/// {@category series}
class HighchartsStreamgraphSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph.name
  String? name;

  /// Configuration options for the HighchartsStreamgraphSeries.
  HighchartsStreamgraphSeriesOptions? options;

  /// List of data point objects for the HighchartsStreamgraphSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsStreamgraphSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsStreamgraphSeriesDataOptions>? dataPoints;
  @override
  get type => 'streamgraph';

  /// A `streamgraph` series. If the type option is not specified, it is inherited from chart.type.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph
  HighchartsStreamgraphSeries({
    this.data,
    this.name,
    this.options,
    this.dataPoints,
