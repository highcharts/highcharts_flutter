...
class HighchartsFlagsSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.data.events
  HighchartsFlagsSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
