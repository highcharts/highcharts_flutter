...
import 'highcharts_vector_series_cluster_options.dart';
...
import 'highcharts_vector_series_states_options.dart';
import 'highcharts_vector_series_tooltip_options.dart';
...
export 'highcharts_vector_series_cluster_options.dart';
...
export 'highcharts_vector_series_states_options.dart';
export 'highcharts_vector_series_tooltip_options.dart';
...
class HighchartsVectorSeriesOptions extends HighchartsOptionsBase {
  /// Accessibility options for a series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.allowPointSelect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.animationLimit
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.clip
  ...
  /// `className` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.colorAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.colorIndex
  ...
  /// is set to `'sum'`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.colorKey
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.vector.compare
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.vector.compareBase
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.vector.compareStart
  ...
  /// is rendered blurry.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.crisp
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.vector.cumulative
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.vector.cumulativeStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.cursor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.custom
  ...
  /// (see example).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.dataLabels

  List<HighchartsSeriesDataLabelsOptions>? dataLabels;

  /// Options for the series data sorting.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.dataSorting
  ...
  /// about the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.enableMouseTracking
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.events
  ...
  /// series only.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.getExtremesFromAll
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.id
  ...
  /// with large datasets.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.inactiveOtherPoints
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.includeInDataExport
  ...
  /// legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.index
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.keys
  ...
  /// `graph` or an `area`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.label

  HighchartsSeriesLabelOptions? label;

  /// The line marks the last price from all points.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.vector.lastPrice

  HighchartsSeriesLastPriceOptions? lastPrice;

  /// The line marks the last price from visible range of points.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.vector.lastVisiblePrice

  HighchartsSeriesLastVisiblePriceOptions? lastVisiblePrice;

  /// The sequential index of the series in the legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.legendIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.legendSymbol

  String? legendSymbol;

  /// The line width for each vector arrow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.lineWidth
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.linkedTo
  ...
  /// defined both places.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.vector.navigatorOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.negativeColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.nullInteraction
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.onPoint

  HighchartsSeriesOnPointOptions? onPoint;

  /// Opacity of a series parts: line, fill (e.g. area) and dataLabels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.opacity

  double? opacity;

  /// Properties for each single point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.point
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.pointDescriptionFormat
  ...
  /// but for an individual series. Overrides the chart wide configuration.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.pointDescriptionFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.pointInterval
  ...
  /// interval of the axis ticks, which is independent.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.pointIntervalUnit
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.vector.pointRange
  ...
  /// value.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.pointStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.relativeXValue
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.selected
  ...
  /// the `selected` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.showCheckbox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.showInLegend
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.vector.showInNavigator
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.skipKeyboardNavigation
  ...
  /// at 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.softThreshold

  bool? softThreshold;

  /// Sonification/audio chart options for a series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.sonification
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.stack
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.stickyTracking
  ...
  /// negativeColor.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.threshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.turboThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.visible
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.xAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.yAxis

  dynamic yAxis;

  /// Define the visual z index of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.zIndex

  double? zIndex;

  /// Defines the Axis on which the zones are applied.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.zoneAxis
  ...
  /// (view live demo).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.zones
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.zoomEnabled
  ...
  void toOptionsJSON(StringBuffer buffer) {
    ...
    if (rotationOrigin != null) {
      buffer
          .writeAll(['"rotationOrigin":', jsonEncode(rotationOrigin), ','], '');
    }
    if (selected != null) {
