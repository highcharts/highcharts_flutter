...
import 'highcharts_pyramid3d_series_data_options.dart';
...
export 'highcharts_pyramid3d_series_data_options.dart';
...
class HighchartsPyramid3DSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.name
  String? name;

  /// Configuration options for the HighchartsPyramid3DSeries.
  HighchartsPyramid3DSeriesOptions? options;

  /// List of data point objects for the HighchartsPyramid3DSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsPyramid3DSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsPyramid3DSeriesDataOptions>? dataPoints;
  @override
  get type => 'pyramid3d';
