...
class HighchartsHollowcandlestickSeriesDataAccessibilityOptions
    extends HighchartsOptionsBase {
  /// Provide a description of the data point, announced to screen readers.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.data.accessibility.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.data.accessibility.enabled
