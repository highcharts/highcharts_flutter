...
import 'highcharts_bubble_series_states_hover_options.dart';
...
export 'highcharts_bubble_series_states_hover_options.dart';
...
class HighchartsBubbleSeriesStatesOptions extends HighchartsOptionsBase {
  /// Highcharts Options Widget.
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.states.inactive
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.states.normal
  ...
  /// or programmatically.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.states.select
