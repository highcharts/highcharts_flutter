...
///
/// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.events
class HighchartsGeoHeatmapSeriesDataEventsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.geoheatmap.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.geoheatmap.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.geoheatmap.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.geoheatmap.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.geoheatmap.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.geoheatmap.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.geoheatmap.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.geoheatmap.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.geoheatmap.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.geoheatmap.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.events
  HighchartsGeoHeatmapSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
