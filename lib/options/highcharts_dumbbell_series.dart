...
import 'highcharts_dumbbell_series_data_options.dart';
...
export 'highcharts_dumbbell_series_data_options.dart';
...
class HighchartsDumbbellSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.name
  String? name;

  /// Configuration options for the HighchartsDumbbellSeries.
  HighchartsDumbbellSeriesOptions? options;

  /// List of data point objects for the HighchartsDumbbellSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsDumbbellSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsDumbbellSeriesDataOptions>? dataPoints;
  @override
  get type => 'dumbbell';
