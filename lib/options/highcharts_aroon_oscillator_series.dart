...
class HighchartsAroonOscillatorSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.name
  String? name;

  /// Configuration options for the HighchartsAroonOscillatorSeries.
  HighchartsAroonOscillatorSeriesOptions? options;

  /// List of data point objects for the HighchartsAroonOscillatorSeries series.
  ///
