...
class HighchartsAreaRangeSeriesDataLabelsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.alignTo
  ...
  /// can be set to 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.allowOverlap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.backgroundColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.borderColor

  String? borderColor;

  /// The border radius in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.borderRadius

  double? borderRadius;

  /// The border width in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.borderWidth
  ...
  /// shadow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.color
  ...
  /// option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.crop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.defer

  bool? defer;

  /// Enable or disable the data labels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.filter
  ...
  /// `formatter`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.format
  ...
  /// ignored.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.formatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.inside
  ...
  /// points, like `pie`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.overflow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.padding
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.position
  ...
  /// rotated data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.rotation
  ...
  /// and `width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.shadow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.shape
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.style
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.textPath
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.useHTML
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.xHigh

  double? xHigh;

  /// X offset of the lower data labels relative to the point value.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.xLow

  double? xLow;

  /// Y offset of the higher data labels relative to the point value.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.yHigh

  double? yHigh;

  /// Y offset of the lower data labels relative to the point value.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.yLow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels.zIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.dataLabels
  HighchartsAreaRangeSeriesDataLabelsOptions(
      {this.align,
      this.alignTo,
      this.allowOverlap,
      this.animation,
