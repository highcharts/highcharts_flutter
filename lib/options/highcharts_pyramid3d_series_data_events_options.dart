...
class HighchartsPyramid3DSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.data.events
  HighchartsPyramid3DSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
