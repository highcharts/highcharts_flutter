...
class HighchartsLinearRegressionSeriesTooltipOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.linearregression.tooltip.changeDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.dateTimeLabelFormats

  HighchartsTooltipDateTimeLabelFormatsOptions? dateTimeLabelFormats;

  /// Distance from point to tooltip in pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.distance
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.headerFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.nullFormatter
  ...
  /// point color.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.pointFormat
  ...
  /// flexibility.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.pointFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.position
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregression.tooltip.xDateFormat
