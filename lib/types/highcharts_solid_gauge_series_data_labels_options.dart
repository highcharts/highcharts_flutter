...
class HighchartsSolidGaugeSeriesDataLabelsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.align
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.alignTo
  ...
  /// can be set to 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.allowOverlap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.backgroundColor
  ...
  /// shadow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.filter
  ...
  /// `formatter`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.format
  ...
  /// ignored.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.formatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.inside
  ...
  /// points, like `pie`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.overflow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.padding
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.position
  ...
  /// rotated data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.rotation
  ...
  /// and `width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.shadow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.shape
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.style
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.textPath
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.useHTML
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.dataLabels.x
  ...
  /// Highcharts Options Widget.
  HighchartsSolidGaugeSeriesDataLabelsOptions(
      {this.align,
      this.alignTo,
      this.allowOverlap,
      this.animation,
