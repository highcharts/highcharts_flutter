...
class HighchartsDependencyWheelSeriesTooltipOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.dateTimeLabelFormats
  ...
  /// the item.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.nodeFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.position
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.valueDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.tooltip.xDateFormat
