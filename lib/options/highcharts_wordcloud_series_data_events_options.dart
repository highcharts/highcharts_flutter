...
class HighchartsWordcloudSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.events
  HighchartsWordcloudSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
