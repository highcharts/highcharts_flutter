...
class HighchartsArcDiagramSeriesTooltipOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.dateTimeLabelFormats
  ...
  /// the item.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.nodeFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.nodeFormatter
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.nullFormatter
  ...
  /// flexibility.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.pointFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.position
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.valueDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.tooltip.xDateFormat
