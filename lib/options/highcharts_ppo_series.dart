...
class HighchartsPPOSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ppo.name
  String? name;

  /// Configuration options for the HighchartsPPOSeries.
  HighchartsPPOSeriesOptions? options;

  /// List of data point objects for the HighchartsPPOSeries series.
  ///
