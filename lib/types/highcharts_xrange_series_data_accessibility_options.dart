...
class HighchartsXRangeSeriesDataAccessibilityOptions
    extends HighchartsOptionsBase {
  /// Provide a description of the data point, announced to screen readers.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.data.accessibility.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.data.accessibility.enabled
