...
class HighchartsGaugeSeriesDataLabelsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.align
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.alignTo
  ...
  /// can be set to 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.allowOverlap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.backgroundColor
  ...
  /// shadow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.filter
  ...
  /// `formatter`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.format
  ...
  /// ignored.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.formatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.inside
  ...
  /// points, like `pie`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.overflow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.padding
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.position
  ...
  /// rotated data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.rotation
  ...
  /// and `width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.shadow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.shape
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.style
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.textPath
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.useHTML
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels.x
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.dataLabels
  HighchartsGaugeSeriesDataLabelsOptions(
      {this.align,
      this.alignTo,
      this.allowOverlap,
      this.animation,
