...
class HighchartsStreamgraphSeriesDataEventsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.streamgraph.data.events
  HighchartsStreamgraphSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
