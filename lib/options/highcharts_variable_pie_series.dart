...
import 'highcharts_variable_pie_series_data_options.dart';
...
export 'highcharts_variable_pie_series_data_options.dart';
...
class HighchartsVariablePieSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.name
  String? name;

  /// Configuration options for the HighchartsVariablePieSeries.
  HighchartsVariablePieSeriesOptions? options;

  /// List of data point objects for the HighchartsVariablePieSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsVariablePieSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsVariablePieSeriesDataOptions>? dataPoints;
  @override
  get type => 'variablepie';
