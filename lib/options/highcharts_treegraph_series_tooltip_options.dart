...
class HighchartsTreegraphSeriesTooltipOptions extends HighchartsOptionsBase {
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.dateTimeLabelFormats

  HighchartsTooltipDateTimeLabelFormatsOptions? dateTimeLabelFormats;

  /// Distance from point to tooltip in pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.distance
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.headerFormat
  ...
  /// the point color.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.linkFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.position
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.valueDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.tooltip.xDateFormat

  String? xDateFormat;

  /// Highcharts Options Widget.
  HighchartsTreegraphSeriesTooltipOptions(
