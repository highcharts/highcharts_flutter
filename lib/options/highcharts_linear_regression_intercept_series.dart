...
class HighchartsLinearRegressionInterceptSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionintercept.name
  String? name;

  /// Configuration options for the HighchartsLinearRegressionInterceptSeries.
  HighchartsLinearRegressionInterceptSeriesOptions? options;

  /// List of data point objects for the HighchartsLinearRegressionInterceptSeries series.
  ///
