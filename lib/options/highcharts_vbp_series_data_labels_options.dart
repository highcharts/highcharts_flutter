...
import 'highcharts_vbp_series_data_labels_style_options.dart';
...
export 'highcharts_vbp_series_data_labels_style_options.dart';
...
class HighchartsVBPSeriesDataLabelsOptions extends HighchartsOptionsBase {
  /// Highcharts Options Widget.
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.alignTo
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.backgroundColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.borderColor

  String? borderColor;

  /// The border radius in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.borderRadius

  double? borderRadius;

  /// The border width in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.borderWidth
  ...
  /// shadow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.color
  ...
  /// option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.crop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.defer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.filter
  ...
  /// ignored.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.formatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.inside
  ...
  /// points, like `pie`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.overflow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.position
  ...
  /// rotated data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.rotation
  ...
  /// and `width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.shadow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.shape

  String? shape;

  /// Highcharts Options Widget.

  HighchartsVBPSeriesDataLabelsStyleOptions? style;
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.textPath
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.useHTML
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.x
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.y
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.dataLabels.zIndex

  double? zIndex;

  /// Highcharts Options Widget.
  HighchartsVBPSeriesDataLabelsOptions(
      {this.align,
      this.alignTo,
      this.allowOverlap,
      this.animation,
