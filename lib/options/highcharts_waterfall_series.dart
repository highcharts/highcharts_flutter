...
import 'highcharts_waterfall_series_data_options.dart';
...
export 'highcharts_waterfall_series_data_options.dart';
...
class HighchartsWaterfallSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsWaterfallSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsWaterfallSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsWaterfallSeriesDataOptions>? dataPoints;
  @override
  get type => 'waterfall';
