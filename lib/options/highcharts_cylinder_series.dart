...
import 'highcharts_cylinder_series_data_options.dart';
...
export 'highcharts_cylinder_series_data_options.dart';
...
class HighchartsCylinderSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.name
  String? name;

  /// Configuration options for the HighchartsCylinderSeries.
  HighchartsCylinderSeriesOptions? options;

  /// List of data point objects for the HighchartsCylinderSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsCylinderSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsCylinderSeriesDataOptions>? dataPoints;
  @override
  get type => 'cylinder';
