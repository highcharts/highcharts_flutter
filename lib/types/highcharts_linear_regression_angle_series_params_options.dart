...
class HighchartsLinearRegressionAngleSeriesParamsOptions
    extends HighchartsOptionsBase {
  /// The point index which indicator calculations will base. For
  /// example using OHLC data, index=2 means the indicator will be
  /// calculated using Low values.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionangle.params.index
  ...
  /// calculations.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionangle.params.period
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.linearregressionangle.params.xAxisUnit

  double? xAxisUnit;

  /// Highcharts Options Widget.
  HighchartsLinearRegressionAngleSeriesParamsOptions(
