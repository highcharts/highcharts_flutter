...
class HighchartsVariablePieSeriesDataEventsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.data.events
  HighchartsVariablePieSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
