...
class MapBounds extends OptionFragment {
  MapBounds( ) : super();
  // NOTE: midX skipped - type number is ignored in gen 

  // NOTE: midY skipped - type number is ignored in gen 
  ...
  void toJSONInner(StringBuffer buffer) {
    ...
    // NOTE: skip serialization of midX (type number is ignored) ignore type: true

    // NOTE: skip serialization of midY (type number is ignored) ignore type: true
