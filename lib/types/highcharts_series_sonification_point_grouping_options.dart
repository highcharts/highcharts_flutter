...
class HighchartsSeriesSonificationPointGroupingOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.sonification.pointGrouping.algorithm

  String? algorithm;

  /// Whether or not to group points
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.sonification.pointGrouping.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.sonification.pointGrouping.groupTimespan
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.sonification.pointGrouping.prop
