...
class HighchartsSeriesPointEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.point.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.point.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.point.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.point.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.point.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.point.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.point.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.point.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.point.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.point.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.point.events
  HighchartsSeriesPointEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
