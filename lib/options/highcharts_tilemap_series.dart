...
import 'highcharts_tilemap_series_data_options.dart';
...
export 'highcharts_tilemap_series_data_options.dart';
...
class HighchartsTilemapSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsTilemapSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsTilemapSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsTilemapSeriesDataOptions>? dataPoints;
  @override
  get type => 'tilemap';
