...
/// {@category series}
class HighchartsPCSeries extends HighchartsSeries {
  /// Highcharts Options Widget.
  List<List<dynamic>>? data;

  /// The name of the series as shown in the legend, tooltip etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pc.name
  String? name;

  /// Configuration options for the HighchartsPCSeries.
  HighchartsPCSeriesOptions? options;

  /// List of data point objects for the HighchartsPCSeries series.
  ///
