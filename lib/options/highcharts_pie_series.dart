...
import 'highcharts_pie_series_data_options.dart';
...
export 'highcharts_pie_series_data_options.dart';
...
/// {@category series}
class HighchartsPieSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.name
  String? name;

  /// Configuration options for the HighchartsPieSeries.
  HighchartsPieSeriesOptions? options;

  /// List of data point objects for the HighchartsPieSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsPieSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsPieSeriesDataOptions>? dataPoints;
  @override
  get type => 'pie';
