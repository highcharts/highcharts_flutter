...
import 'highcharts_polygon_series_data_options.dart';
...
export 'highcharts_polygon_series_data_options.dart';
...
class HighchartsPolygonSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.name
  String? name;

  /// Configuration options for the HighchartsPolygonSeries.
  HighchartsPolygonSeriesOptions? options;

  /// List of data point objects for the HighchartsPolygonSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsPolygonSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsPolygonSeriesDataOptions>? dataPoints;
  @override
  get type => 'polygon';
