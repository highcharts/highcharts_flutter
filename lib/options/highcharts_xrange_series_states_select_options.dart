...
class HighchartsXRangeSeriesStatesSelectOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.states.select.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.states.select
  HighchartsXRangeSeriesStatesSelectOptions(
