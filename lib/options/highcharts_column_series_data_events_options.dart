...
class HighchartsColumnSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.events
  HighchartsColumnSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
