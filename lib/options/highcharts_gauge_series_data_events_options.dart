...
class HighchartsGaugeSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.gauge.data.events
  HighchartsGaugeSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
