...
class HighchartsWilliamsRSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.williamsr.name
  String? name;

  /// Configuration options for the HighchartsWilliamsRSeries.
  HighchartsWilliamsRSeriesOptions? options;

  /// List of data point objects for the HighchartsWilliamsRSeries series.
  ///
