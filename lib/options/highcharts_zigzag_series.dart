...
/// {@category series}
class HighchartsZigzagSeries extends HighchartsSeries {
  /// Highcharts Options Widget.
  List<List<dynamic>>? data;

  /// The name of the series as shown in the legend, tooltip etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.zigzag.name
  String? name;

  /// Configuration options for the HighchartsZigzagSeries.
  HighchartsZigzagSeriesOptions? options;

  /// List of data point objects for the HighchartsZigzagSeries series.
  ///
