...
import 'highcharts_column_pyramid_series_data_options.dart';
...
export 'highcharts_column_pyramid_series_data_options.dart';
...
class HighchartsColumnPyramidSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsColumnPyramidSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsColumnPyramidSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsColumnPyramidSeriesDataOptions>? dataPoints;
  @override
