...
import 'highcharts_arc_diagram_series_data_labels_link_text_path_options.dart';
...
export 'highcharts_arc_diagram_series_data_labels_link_text_path_options.dart';
...
class HighchartsArcDiagramSeriesDataLabelsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.alignTo
  ...
  /// can be set to 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.allowOverlap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.borderColor

  String? borderColor;

  /// The border radius in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.borderRadius

  double? borderRadius;

  /// The border width in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.borderWidth
  ...
  /// shadow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.defer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.filter
  ...
  HighchartsArcDiagramSeriesDataLabelsLinkTextPathOptions? linkTextPath;
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.nodeFormat
  ...
  /// `nodeFormatter`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.nodeFormatter
  ...
  /// points, like `pie`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.overflow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.padding
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.position
  ...
  /// rotated data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.rotation
  ...
  /// and `width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.shadow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.shape
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.style
  ...
  /// `useHTML` to true will disable this option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.textPath
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.useHTML
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.x
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.y
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels.zIndex

  double? zIndex;

  /// Options for the data labels appearing on top of the nodes and links. For arc diagram charts, data labels are visible for the nodes by default, but hidden for links. This is controlled by modifying the `nodeFormat`, and the `format` that applies to links and is an empty string by default.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arcdiagram.dataLabels
