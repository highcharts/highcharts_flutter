...
class HighchartsDumbbellSeriesDragDropOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.dragHandle

  HighchartsSeriesDragDropDragHandleOptions? dragHandle;

  /// Set the maximum X value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.dragMaxX

  dynamic dragMaxX;

  /// Set the maximum Y value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.dragMaxY

  double? dragMaxY;

  /// Set the minimum X value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.dragMinX

  dynamic dragMinX;

  /// Set the minimum Y value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.dragMinY
  ...
  /// `1`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.dragPrecisionX
  ...
  /// `1`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.dragPrecisionY
  ...
  /// selecting points.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.dragSensitivity

  double? dragSensitivity;

  /// Allow high value to be dragged individually.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.draggableHigh

  bool? draggableHigh;

  /// Allow low value to be dragged individually.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.draggableLow

  bool? draggableLow;

  /// Enable dragging in the X dimension.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.draggableX
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.draggableY
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.groupBy
  ...
  /// the `default` state.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.guideBox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dragDrop.liveRedraw
