...
class HighchartsSlowStochasticSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.name
  String? name;

  /// Configuration options for the HighchartsSlowStochasticSeries.
  HighchartsSlowStochasticSeriesOptions? options;

  /// List of data point objects for the HighchartsSlowStochasticSeries series.
  ///
