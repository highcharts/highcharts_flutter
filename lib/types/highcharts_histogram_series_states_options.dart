...
import 'highcharts_histogram_series_states_hover_options.dart';
import 'highcharts_series_states_inactive_options.dart';
import 'highcharts_series_states_normal_options.dart';
import 'highcharts_histogram_series_states_select_options.dart';
...
export 'highcharts_histogram_series_states_hover_options.dart';
export 'highcharts_series_states_inactive_options.dart';
export 'highcharts_series_states_normal_options.dart';
export 'highcharts_histogram_series_states_select_options.dart';
...
class HighchartsHistogramSeriesStatesOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.histogram.states.inactive
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.histogram.states.normal
