...
class HighchartsVectorSeriesClusterOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.cluster.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.cluster.drillToCluster

  bool? drillToCluster;

  /// Whether to enable the marker-clusters module.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.cluster.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.cluster.minimumClusterSize
