...
class HighchartsSunburstSeriesStatesHoverOptions extends HighchartsOptionsBase {
  ...
  /// class.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.states.hover.brightness

  double? brightness;

  /// Animation setting for hovering the graph in line-type series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.states.hover.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.states.hover.enabled
  ...
  /// `.highcharts-color-{n}`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.states.hover.halo

  HighchartsSeriesStatesHoverHaloOptions? halo;

  /// Highcharts Options Widget.
  HighchartsSunburstSeriesStatesHoverOptions(
