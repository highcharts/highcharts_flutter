...
class HighchartsItemSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.data.events
  HighchartsItemSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
