...
import 'highcharts_spline_series_data_options.dart';
...
export 'highcharts_spline_series_data_options.dart';
...
/// {@category series}
class HighchartsSplineSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.spline.name
  String? name;

  /// Configuration options for the HighchartsSplineSeries.
  HighchartsSplineSeriesOptions? options;

  /// List of data point objects for the HighchartsSplineSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsSplineSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsSplineSeriesDataOptions>? dataPoints;
  @override
  get type => 'spline';
