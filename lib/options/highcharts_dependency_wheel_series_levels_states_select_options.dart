...
class HighchartsDependencyWheelSeriesLevelsStatesSelectOptions
    extends HighchartsOptionsBase {
  /// A specific border color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.levels.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.levels.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.levels.states.select.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.levels.states.select
  HighchartsDependencyWheelSeriesLevelsStatesSelectOptions(
