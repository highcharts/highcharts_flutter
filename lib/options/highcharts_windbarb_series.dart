...
import 'highcharts_windbarb_series_data_options.dart';
...
export 'highcharts_windbarb_series_data_options.dart';
...
class HighchartsWindbarbSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.name
  String? name;

  /// Configuration options for the HighchartsWindbarbSeries.
  HighchartsWindbarbSeriesOptions? options;

  /// List of data point objects for the HighchartsWindbarbSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsWindbarbSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsWindbarbSeriesDataOptions>? dataPoints;
  @override
  get type => 'windbarb';
