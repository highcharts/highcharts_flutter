...
class HighchartsScatter3DSeriesJitterOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter3d.jitter.x

  double? x;

  /// The maximal Y offset for the random jitter effect.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter3d.jitter.y
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter3d.jitter
  HighchartsScatter3DSeriesJitterOptions({this.x, this.y});
