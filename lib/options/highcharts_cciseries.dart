...
class HighchartsCCISeries extends HighchartsSeries {
  /// Highcharts Options Widget.
  List<List<dynamic>>? data;

  /// The name of the series as shown in the legend, tooltip etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cci.name
  String? name;

  /// Configuration options for the HighchartsCCISeries.
  HighchartsCCISeriesOptions? options;

  /// List of data point objects for the HighchartsCCISeries series.
  ///
