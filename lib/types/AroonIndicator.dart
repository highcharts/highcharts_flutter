...
class AroonIndicator extends OptionFragment {
  ...
  void toJSONInner(StringBuffer buffer) {
    ...
    // NOTE: skip serialization of pointArrayMap (type (keyof AroonPoint)[] is ignored) ignore type: true

    // NOTE: skip serialization of pointValKey (type string is ignored) ignore type: true

    // NOTE: skip serialization of pointClass (type typeof AroonPoint is ignored) ignore type: true
  }
