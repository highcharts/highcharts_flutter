...
/// on `series.dragDrop`.
///
/// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop
class HighchartsPolygonSeriesDataDragDropOptions extends HighchartsOptionsBase {
  /// Options for the drag handles available in column series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.dragHandle

  HighchartsSeriesDragDropDragHandleOptions? dragHandle;

  /// Set the maximum X value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.dragMaxX

  dynamic dragMaxX;

  /// Set the maximum Y value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.dragMaxY

  double? dragMaxY;

  /// Set the minimum X value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.dragMinX

  dynamic dragMinX;

  /// Set the minimum Y value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.dragMinY
  ...
  /// `1`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.dragPrecisionX
  ...
  /// `1`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.dragPrecisionY
  ...
  /// selecting points.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.dragSensitivity

  double? dragSensitivity;

  /// Enable dragging in the X dimension.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.draggableX
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.draggableY
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.groupBy
  ...
  /// the `default` state.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.guideBox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop.liveRedraw
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.dragDrop
  HighchartsPolygonSeriesDataDragDropOptions(
      {this.dragHandle,
      this.dragMaxX,
      this.dragMaxY,
      this.dragMinX,
