...
import 'highcharts_pictorial_series_data_options.dart';
...
export 'highcharts_pictorial_series_data_options.dart';
...
class HighchartsPictorialSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pictorial.name
  String? name;

  /// Configuration options for the HighchartsPictorialSeries.
  HighchartsPictorialSeriesOptions? options;

  /// List of data point objects for the HighchartsPictorialSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsPictorialSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsPictorialSeriesDataOptions>? dataPoints;
  @override
  get type => 'pictorial';
