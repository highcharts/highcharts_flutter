...
class HighchartsPieSeriesEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.events.afterAnimate
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.events.checkboxClick
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.events.hide
  ...
  /// plot area.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.events.show
