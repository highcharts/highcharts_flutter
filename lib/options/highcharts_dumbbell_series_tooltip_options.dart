...
class HighchartsDumbbellSeriesTooltipOptions extends HighchartsOptionsBase {
  /// How many decimals to show for the `point.change`
  /// or the `point.cumulativeSum` value when the `series.compare`
  /// or the `series.cumulative` option is set.
  /// This is overridable in each series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.tooltip.changeDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.dateTimeLabelFormats

  HighchartsTooltipDateTimeLabelFormatsOptions? dateTimeLabelFormats;

  /// Distance from point to tooltip in pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.distance
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.headerFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.position
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.valueDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.tooltip.xDateFormat

  String? xDateFormat;

  /// Highcharts Options Widget.
  HighchartsDumbbellSeriesTooltipOptions(
      {this.changeDecimals,
      this.clusterFormat,
