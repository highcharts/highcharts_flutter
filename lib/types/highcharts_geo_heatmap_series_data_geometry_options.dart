...
class HighchartsGeoHeatmapSeriesDataGeometryOptions
  ...
  /// `type`.
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.geometry.coordinates
  ...
  /// or `MultiPolygon`.
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.geometry.type
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.geometry
  HighchartsGeoHeatmapSeriesDataGeometryOptions({this.coordinates, this.type});
