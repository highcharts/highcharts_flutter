...
class HighchartsPyramidSeriesEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.events.afterAnimate
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.events.checkboxClick
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.events.hide
  ...
  /// plot area.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.events.show
