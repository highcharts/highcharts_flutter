...
class HighchartsPivotPointsSeriesDataLabelsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.align
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.alignTo
  ...
  /// can be set to 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.allowOverlap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.backgroundColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.borderColor

  String? borderColor;

  /// The border radius in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.borderRadius

  double? borderRadius;

  /// The border width in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.borderWidth
  ...
  /// shadow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.color
  ...
  /// option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.crop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.defer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.filter
  ...
  /// ignored.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.formatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.inside
  ...
  /// points, like `pie`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.overflow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.padding
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.position
  ...
  /// rotated data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.rotation
  ...
  /// and `width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.shadow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.shape
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.style
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.textPath
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.useHTML
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.verticalAlign
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.x
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.y
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pivotpoints.dataLabels.zIndex

  double? zIndex;

  /// Highcharts Options Widget.
  HighchartsPivotPointsSeriesDataLabelsOptions(
      {this.align,
      this.alignTo,
      this.allowOverlap,
      this.animation,
