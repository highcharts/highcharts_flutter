...
import 'highcharts_error_bar_series_data_options.dart';
...
export 'highcharts_error_bar_series_data_options.dart';
...
class HighchartsErrorBarSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.name
  String? name;

  /// Configuration options for the HighchartsErrorBarSeries.
  HighchartsErrorBarSeriesOptions? options;

  /// List of data point objects for the HighchartsErrorBarSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsErrorBarSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsErrorBarSeriesDataOptions>? dataPoints;
  @override
  get type => 'errorbar';
