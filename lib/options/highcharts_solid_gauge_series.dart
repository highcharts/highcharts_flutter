...
import 'highcharts_solid_gauge_series_data_options.dart';
...
export 'highcharts_solid_gauge_series_data_options.dart';
...
class HighchartsSolidGaugeSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.name
  String? name;

  /// Configuration options for the HighchartsSolidGaugeSeries.
  HighchartsSolidGaugeSeriesOptions? options;

  /// List of data point objects for the HighchartsSolidGaugeSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsSolidGaugeSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsSolidGaugeSeriesDataOptions>? dataPoints;
  @override
  get type => 'solidgauge';
