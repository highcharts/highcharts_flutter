...
class HighchartsVBPSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vbp.name
  String? name;

  /// Configuration options for the HighchartsVBPSeries.
  HighchartsVBPSeriesOptions? options;

  /// List of data point objects for the HighchartsVBPSeries series.
  ///
