...
class HighchartsWaterfallSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.waterfall.data.events
  HighchartsWaterfallSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
