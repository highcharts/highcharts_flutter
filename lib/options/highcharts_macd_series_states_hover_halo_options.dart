...
class HighchartsMACDSeriesStatesHoverHaloOptions extends HighchartsOptionsBase {
  ...
  /// `stroke-width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.macd.states.hover.halo.attributes
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.macd.states.hover.halo.opacity
