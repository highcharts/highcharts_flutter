...
///    available.
///
/// API Docs: https://api.highcharts.com/highcharts/series.polygon.data
class HighchartsPolygonSeriesDataOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.className
  ...
  /// `colorIndex`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.colorIndex
  ...
  /// callbacks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.custom
  ...
  /// about the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.drilldown

  String? drilldown;

  /// The individual point events.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.id
  ...
  /// will be drawn.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.labelrank

  double? labelrank;

  /// Options for the point markers of line-like series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.marker

  HighchartsPolygonSeriesDataMarkerOptions? marker;

  /// The name of the point as shown in the legend, tooltip, dataLabels, etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.name

  String? name;

  /// Whether the data point is selected initially.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.selected
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.x

  dynamic x;

  /// The y value of the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.y
