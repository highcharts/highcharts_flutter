...
import 'highcharts_area_spline_series_data_options.dart';
...
export 'highcharts_area_spline_series_data_options.dart';
...
class HighchartsAreaSplineSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsAreaSplineSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsAreaSplineSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsAreaSplineSeriesDataOptions>? dataPoints;
  @override
  get type => 'areaspline';
