...
import 'highcharts_area_range_series_data_options.dart';
...
export 'highcharts_area_range_series_data_options.dart';
...
/// {@category series}
class HighchartsAreaRangeSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.arearange.name
  String? name;

  /// Configuration options for the HighchartsAreaRangeSeries.
  HighchartsAreaRangeSeriesOptions? options;

  /// List of data point objects for the HighchartsAreaRangeSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsAreaRangeSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsAreaRangeSeriesDataOptions>? dataPoints;
  @override
  get type => 'arearange';
