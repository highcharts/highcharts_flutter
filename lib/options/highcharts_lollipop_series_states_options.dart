...
import 'highcharts_lollipop_series_states_hover_options.dart';
...
export 'highcharts_lollipop_series_states_hover_options.dart';
...
class HighchartsLollipopSeriesStatesOptions extends HighchartsOptionsBase {
  /// Highcharts Options Widget.
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.states.inactive
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.states.normal
  ...
  /// or programmatically.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.states.select
