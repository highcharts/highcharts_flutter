...
class HighchartsAreaSeriesDataOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.className
  ...
  /// `colorIndex`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.colorIndex
  ...
  /// callbacks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.custom
  ...
  /// about the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.drilldown

  String? drilldown;

  /// The individual point events.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.id
  ...
  /// will be drawn.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.labelrank

  double? labelrank;

  /// Options for the point markers of line-like series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.marker

  HighchartsAreaSeriesDataMarkerOptions? marker;

  /// The name of the point as shown in the legend, tooltip, dataLabels, etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.name

  String? name;

  /// Whether the data point is selected initially.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.selected
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.x

  dynamic x;

  /// The y value of the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.data.y
