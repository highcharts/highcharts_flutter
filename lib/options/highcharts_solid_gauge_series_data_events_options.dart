...
class HighchartsSolidGaugeSeriesDataEventsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.solidgauge.data.events
  HighchartsSolidGaugeSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
