...
class HighchartsNATRSeriesTooltipOptions extends HighchartsOptionsBase {
  /// How many decimals to show for the `point.change`
  /// or the `point.cumulativeSum` value when the `series.compare`
  /// or the `series.cumulative` option is set.
  /// This is overridable in each series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.natr.tooltip.changeDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.dateTimeLabelFormats

  HighchartsTooltipDateTimeLabelFormatsOptions? dateTimeLabelFormats;

  /// Distance from point to tooltip in pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.distance
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.headerFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.nullFormatter
  ...
  /// point color.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.pointFormat
  ...
  /// flexibility.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.pointFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.position

  HighchartsTooltipPositionOptions? position;

  /// Number of decimals in indicator series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.valueDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.valuePrefix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.natr.tooltip.xDateFormat

  String? xDateFormat;

  /// Highcharts Options Widget.
  HighchartsNATRSeriesTooltipOptions(
      {this.changeDecimals,
      this.clusterFormat,
