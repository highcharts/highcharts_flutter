...
import 'highcharts_sankey_series_data_options.dart';
...
export 'highcharts_sankey_series_data_options.dart';
...
class HighchartsSankeySeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.name
  String? name;

  /// Configuration options for the HighchartsSankeySeries.
  HighchartsSankeySeriesOptions? options;

  /// List of data point objects for the HighchartsSankeySeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsSankeySeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsSankeySeriesDataOptions>? dataPoints;
  @override
  get type => 'sankey';
