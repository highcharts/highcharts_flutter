...
import 'highcharts_area_spline_range_series_data_options.dart';
...
export 'highcharts_area_spline_range_series_data_options.dart';
...
class HighchartsAreaSplineRangeSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.areasplinerange.name
  String? name;

  /// Configuration options for the HighchartsAreaSplineRangeSeries.
  HighchartsAreaSplineRangeSeriesOptions? options;

  /// List of data point objects for the HighchartsAreaSplineRangeSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsAreaSplineRangeSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsAreaSplineRangeSeriesDataOptions>? dataPoints;
  @override
