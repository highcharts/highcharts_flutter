...
class HighchartsDependencyWheelSeriesDataOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.className
  ...
  /// `fillOpacity` to 1.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.colorIndex
  ...
  /// callbacks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.custom
  ...
  /// about the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.description

  String? description;

  /// The individual point events.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.events

  HighchartsDependencyWheelSeriesDataEventsOptions? events;

  /// The node that the link runs from.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.from
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.id
  ...
  /// will be drawn.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.labelrank

  double? labelrank;

  /// The name of the point as shown in the legend, tooltip, dataLabels, etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.name

  String? name;

  /// Whether the data point is selected initially.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.selected

  bool? selected;

  /// The node that the link runs to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.to

  String? to;

  /// The weight of the link.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.weight
