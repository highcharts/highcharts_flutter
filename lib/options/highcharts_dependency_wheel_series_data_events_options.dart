...
class HighchartsDependencyWheelSeriesDataEventsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.data.events
  HighchartsDependencyWheelSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
