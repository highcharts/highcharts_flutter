...
import 'highcharts_column_range_series_data_options.dart';
...
export 'highcharts_column_range_series_data_options.dart';
...
class HighchartsColumnRangeSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnrange.name
  String? name;

  /// Configuration options for the HighchartsColumnRangeSeries.
  HighchartsColumnRangeSeriesOptions? options;

  /// List of data point objects for the HighchartsColumnRangeSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsColumnRangeSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsColumnRangeSeriesDataOptions>? dataPoints;
  @override
