...
class StreamgraphSeries extends Series {

  String? name;
  StreamgraphSeriesOptions? options;
  ...
  void toJSONInner(StringBuffer buffer) {
    ...
    if (this.options?.stacking != null) {
        buffer.writeAll(["\"stacking\":\'",this.options?.stacking, "\',"], "");
    }
