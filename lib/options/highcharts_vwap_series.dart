...
class HighchartsVWAPSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vwap.name
  String? name;

  /// Configuration options for the HighchartsVWAPSeries.
  HighchartsVWAPSeriesOptions? options;

  /// List of data point objects for the HighchartsVWAPSeries series.
  ///
