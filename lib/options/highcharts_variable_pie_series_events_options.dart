...
class HighchartsVariablePieSeriesEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.events.afterAnimate
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.events.hide
  ...
  /// plot area.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.events.show
