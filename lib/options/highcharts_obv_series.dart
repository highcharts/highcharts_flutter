...
class HighchartsOBVSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.obv.name
  String? name;

  /// Configuration options for the HighchartsOBVSeries.
  HighchartsOBVSeriesOptions? options;

  /// List of data point objects for the HighchartsOBVSeries series.
  ///
