...
import 'highcharts_funnel3d_series_data_options.dart';
...
export 'highcharts_funnel3d_series_data_options.dart';
...
class HighchartsFunnel3DSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsFunnel3DSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsFunnel3DSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsFunnel3DSeriesDataOptions>? dataPoints;
  @override
  get type => 'funnel3d';
