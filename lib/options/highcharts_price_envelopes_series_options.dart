...
class HighchartsPriceEnvelopesSeriesOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.allowPointSelect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.animationLimit

  double? animationLimit;

  /// Sets the color blending in the boost module.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.boostBlending
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.boostThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.clip
  ...
  /// `className` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.colorIndex
  ...
  /// is set to `'sum'`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.colorKey
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.priceenvelopes.compare
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.priceenvelopes.compareBase
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.priceenvelopes.compareStart
  ...
  /// or indicator values.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.compareToMain
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.connectNulls
  ...
  /// is rendered blurry.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.crisp
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.cropThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.priceenvelopes.cumulative
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.priceenvelopes.cumulativeStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.cursor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.custom
  ...
  /// series.color.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.dashStyle
  ...
  /// (see example).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.dataLabels

  List<HighchartsSeriesDataLabelsOptions>? dataLabels;

  /// Options for the series data sorting.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.dataSorting
  ...
  /// about the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.enableMouseTracking
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.findNearestPointBy
  ...
  /// weekends.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.priceenvelopes.gapSize
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.priceenvelopes.gapUnit
  ...
  /// series only.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.getExtremesFromAll
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.id
  ...
  /// with large datasets.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.inactiveOtherPoints
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.includeInDataExport
  ...
  /// legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.index
  ...
  /// `graph` or an `area`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.label

  HighchartsSeriesLabelOptions? label;

  /// The line marks the last price from all points.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.priceenvelopes.lastPrice

  HighchartsSeriesLastPriceOptions? lastPrice;

  /// The line marks the last price from visible range of points.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.priceenvelopes.lastVisiblePrice

  HighchartsSeriesLastVisiblePriceOptions? lastVisiblePrice;

  /// The sequential index of the series in the legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.legendIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.legendSymbol
  ...
  /// styled mode.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.legendSymbolColor

  String? legendSymbolColor;

  /// Pixel width of the graph line.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.lineWidth
  ...
  /// bends.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.linecap
  ...
  /// indicator.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.linkedTo
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.negativeColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.nullInteraction
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.onPoint

  HighchartsSeriesOnPointOptions? onPoint;

  /// Opacity of a series parts: line, fill (e.g. area) and dataLabels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.opacity
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.point
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.pointDescriptionFormat
  ...
  /// but for an individual series. Overrides the chart wide configuration.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.pointDescriptionFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.relativeXValue
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.selected
  ...
  /// whole series group.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.shadow
  ...
  /// the `selected` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.showCheckbox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.showInLegend
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.skipKeyboardNavigation
  ...
  /// at 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.softThreshold

  bool? softThreshold;

  /// Sonification/audio chart options for a series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.sonification
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.stack
  ...
  /// `center` and `right`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.step
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.stickyTracking
  ...
  /// negativeColor.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.threshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.turboThreshold

  double? turboThreshold;

  /// Set the initial visibility of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.visible
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.xAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.yAxis

  dynamic yAxis;

  /// Define the visual z index of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.zIndex

  double? zIndex;

  /// Defines the Axis on which the zones are applied.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.zoneAxis
  ...
  /// (view live demo).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.zones
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.priceenvelopes.zoomEnabled
