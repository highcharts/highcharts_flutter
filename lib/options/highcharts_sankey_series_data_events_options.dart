...
class HighchartsSankeySeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.data.events
  HighchartsSankeySeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
