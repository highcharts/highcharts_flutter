...
class HighchartsDumbbellSeriesDataOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.className
  ...
  /// `colorIndex`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.colorIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.connectorColor

  String? connectorColor;

  /// Pixel width of the line that connects the dumbbell point's values.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.connectorWidth
  ...
  /// callbacks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.custom
  ...
  /// about the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.description
  ...
  /// on `series.dragDrop`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.dragDrop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.drilldown

  String? drilldown;

  /// The individual point events.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.events

  HighchartsDumbbellSeriesDataEventsOptions? events;

  /// The high or maximum value for each data point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.high
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.id
  ...
  /// will be drawn.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.labelrank

  double? labelrank;

  /// The low or minimum value for each data point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.low
  ...
  /// `undefined`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.lowColor

  String? lowColor;

  /// The name of the point as shown in the legend, tooltip, dataLabels, etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.name

  String? name;

  /// Whether the data point is selected initially.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.selected
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.x
