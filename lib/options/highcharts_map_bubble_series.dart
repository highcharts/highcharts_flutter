...
import 'highcharts_map_bubble_series_data_options.dart';
...
export 'highcharts_map_bubble_series_data_options.dart';
...
class HighchartsMapBubbleSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsMapBubbleSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsMapBubbleSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsMapBubbleSeriesDataOptions>? dataPoints;
  @override
  get type => 'mapbubble';
