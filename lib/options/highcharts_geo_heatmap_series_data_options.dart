...
class HighchartsGeoHeatmapSeriesDataOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.dataLabels
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.drilldown
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.geometry
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.id
  ...
  /// area.
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.labelrank
  ...
  /// there.
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.middleX
  ...
  /// there.
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.middleY
  ...
  /// etc.
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.name
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.path
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.geoheatmap.data.value
