...
class HighchartsCylinderSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cylinder.data.events
  HighchartsCylinderSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
