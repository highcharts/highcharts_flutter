...
/// {@category series}
class HighchartsCMFSeries extends HighchartsSeries {
  /// Highcharts Options Widget.
  List<List<dynamic>>? data;

  /// The name of the series as shown in the legend, tooltip etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.cmf.name
  String? name;

  /// Configuration options for the HighchartsCMFSeries.
  HighchartsCMFSeriesOptions? options;

  /// List of data point objects for the HighchartsCMFSeries series.
  ///
