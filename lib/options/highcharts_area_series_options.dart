...
///
///
/// API Docs: https://api.highcharts.com/highcharts/series.area
class HighchartsAreaSeriesOptions extends HighchartsOptionsBase {
  /// Accessibility options for a series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.allowPointSelect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.animationLimit

  double? animationLimit;

  /// Sets the color blending in the boost module.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.boostBlending
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.boostThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.clip
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.colorAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.colorIndex
  ...
  /// is set to `'sum'`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.colorKey
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.compare
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.compareBase
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.compareStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.connectEnds
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.connectNulls
  ...
  /// is rendered blurry.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.crisp
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.cropThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.cumulative
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.cumulativeStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.cursor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.custom
  ...
  /// series.color.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.dashStyle
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.dataGrouping
  ...
  /// (see example).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.dataLabels

  List<HighchartsSeriesDataLabelsOptions>? dataLabels;

  /// Options for the series data sorting.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.dataSorting
  ...
  /// about the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.description
  ...
  /// point.drop.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.dragDrop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.enableMouseTracking
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.findNearestPointBy
  ...
  /// weekends.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.gapSize
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.gapUnit
  ...
  /// series only.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.getExtremesFromAll
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.id
  ...
  /// with large datasets.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.inactiveOtherPoints
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.includeInDataExport
  ...
  /// legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.index
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.keys
  ...
  /// `graph` or an `area`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.label

  HighchartsSeriesLabelOptions? label;

  /// The line marks the last price from all points.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.lastPrice

  HighchartsSeriesLastPriceOptions? lastPrice;

  /// The line marks the last price from visible range of points.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.lastVisiblePrice

  HighchartsSeriesLastVisiblePriceOptions? lastVisiblePrice;

  /// The sequential index of the series in the legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.legendIndex
  ...
  /// styled mode.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.legendSymbolColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.lineColor

  String? lineColor;

  /// Pixel width of the graph line.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.lineWidth
  ...
  /// bends.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.linecap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.linkedTo
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.marker
  ...
  /// defined both places.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.navigatorOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.negativeColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.negativeFillColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.nullInteraction
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.onPoint

  HighchartsSeriesOnPointOptions? onPoint;

  /// Opacity of a series parts: line, fill (e.g. area) and dataLabels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.opacity

  double? opacity;

  /// Properties for each single point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.point
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.pointDescriptionFormat
  ...
  /// but for an individual series. Overrides the chart wide configuration.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.pointDescriptionFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.pointInterval
  ...
  /// interval of the axis ticks, which is independent.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.pointIntervalUnit
  ...
  /// charts.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.pointPlacement
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.pointRange
  ...
  /// value.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.pointStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.relativeXValue
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.selected
  ...
  /// whole series group.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.shadow
  ...
  /// the `selected` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.showCheckbox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.showInLegend
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.area.showInNavigator
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.skipKeyboardNavigation
  ...
  /// at 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.softThreshold

  bool? softThreshold;

  /// Sonification/audio chart options for a series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.sonification
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.stack
  ...
  /// series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.stacking
  ...
  /// `center` and `right`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.step
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.stickyTracking
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.threshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.tooltip
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.trackByArea
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.turboThreshold

  double? turboThreshold;

  /// Set the initial visibility of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.visible
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.xAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.yAxis

  dynamic yAxis;

  /// Define the visual z index of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.zIndex

  double? zIndex;

  /// Defines the Axis on which the zones are applied.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.zoneAxis
  ...
  /// (view live demo).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.zones
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.area.zoomEnabled
