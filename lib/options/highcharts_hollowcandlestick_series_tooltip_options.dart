...
class HighchartsHollowcandlestickSeriesTooltipOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.hollowcandlestick.tooltip.changeDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.dateTimeLabelFormats
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.headerFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.nullFormatter
  ...
  /// flexibility.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.pointFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.position
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.valueDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.tooltip.xDateFormat

  String? xDateFormat;

  /// Highcharts Options Widget.
  HighchartsHollowcandlestickSeriesTooltipOptions(
      {this.changeDecimals,
      this.clusterFormat,
