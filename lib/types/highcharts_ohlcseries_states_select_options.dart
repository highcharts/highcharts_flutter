...
class HighchartsOHLCSeriesStatesSelectOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.states.select.enabled
