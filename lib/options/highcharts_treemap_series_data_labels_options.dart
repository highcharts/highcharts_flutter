...
import 'highcharts_treemap_series_data_labels_style_options.dart';
...
export 'highcharts_treemap_series_data_labels_style_options.dart';
...
class HighchartsTreemapSeriesDataLabelsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.align
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.alignTo
  ...
  /// can be set to 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.allowOverlap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.backgroundColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.borderColor

  String? borderColor;

  /// The border radius in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.borderRadius

  double? borderRadius;

  /// The border width in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.borderWidth
  ...
  /// shadow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.color
  ...
  /// option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.crop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.defer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.filter
  ...
  /// `formatter`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.format
  ...
  /// ignored.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.formatter
  ...
  /// inside.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.headers
  ...
  /// points, like `pie`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.overflow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.position
  ...
  /// rotated data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.rotation
  ...
  /// and `width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.shadow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.shape

  String? shape;

  /// Highcharts Options Widget.

  HighchartsTreemapSeriesDataLabelsStyleOptions? style;
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.textPath
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.useHTML
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.x
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.y
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.dataLabels.zIndex

  double? zIndex;

  /// Highcharts Options Widget.
  HighchartsTreemapSeriesDataLabelsOptions(
      {this.align,
      this.alignTo,
      this.allowOverlap,
      this.animation,
