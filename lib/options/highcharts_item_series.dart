...
import 'highcharts_item_series_data_options.dart';
...
export 'highcharts_item_series_data_options.dart';
...
/// {@category series}
class HighchartsItemSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.item.name
  String? name;

  /// Configuration options for the HighchartsItemSeries.
  HighchartsItemSeriesOptions? options;

  /// List of data point objects for the HighchartsItemSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsItemSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsItemSeriesDataOptions>? dataPoints;
  @override
  get type => 'item';
