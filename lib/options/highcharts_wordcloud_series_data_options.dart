...
class HighchartsWordcloudSeriesDataOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.className
  ...
  /// `colorIndex`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.colorIndex
  ...
  /// callbacks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.custom
  ...
  /// about the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.id
  ...
  /// will be drawn.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.labelrank

  double? labelrank;

  /// The name decides the text for a word.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.name

  String? name;

  /// Whether the data point is selected initially.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.selected
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data.weight

  double? weight;

  /// An array of data points for the series. For the `wordcloud` series type, points can be given in the following ways:
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.wordcloud.data
