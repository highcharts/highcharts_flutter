...
import 'highcharts_renko_series_data_options.dart';
...
export 'highcharts_renko_series_data_options.dart';
...
class HighchartsRenkoSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsRenkoSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsRenkoSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsRenkoSeriesDataOptions>? dataPoints;
  @override
  get type => 'renko';
