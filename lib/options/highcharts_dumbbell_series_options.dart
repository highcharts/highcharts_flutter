...
class HighchartsDumbbellSeriesOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.allowPointSelect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.animationLimit
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.clip
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.colorAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.colorIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.compare
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.compareBase
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.compareStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.connectEnds
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.connectNulls
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.connectorColor
  ...
  /// values.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.connectorWidth
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.cropThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.cumulative
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.cumulativeStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.cursor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.custom
  ...
  /// series.color.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dashStyle
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.dataGrouping
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dataLabels

  HighchartsDumbbellSeriesDataLabelsOptions? dataLabels;

  /// Options for the series data sorting.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.dataSorting
  ...
  /// about the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.enableMouseTracking
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.findNearestPointBy
  ...
  /// weekends.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.gapSize
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.gapUnit
  ...
  /// series only.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.getExtremesFromAll
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.id
  ...
  /// with large datasets.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.inactiveOtherPoints
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.includeInDataExport
  ...
  /// legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.index
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.keys
  ...
  /// `graph` or an `area`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.label

  HighchartsSeriesLabelOptions? label;

  /// The line marks the last price from all points.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.lastPrice

  HighchartsSeriesLastPriceOptions? lastPrice;

  /// The line marks the last price from visible range of points.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.lastVisiblePrice

  HighchartsSeriesLastVisiblePriceOptions? lastVisiblePrice;

  /// The sequential index of the series in the legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.legendIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.lineColor
  ...
  /// bends.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.linecap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.linkedTo
  ...
  /// `undefined`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.lowColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.marker
  ...
  /// defined both places.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.navigatorOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.negativeColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.negativeFillColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.nullInteraction
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.onPoint

  HighchartsSeriesOnPointOptions? onPoint;

  /// Opacity of a series parts: line, fill (e.g. area) and dataLabels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.opacity

  double? opacity;

  /// Properties for each single point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.point
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.pointDescriptionFormat
  ...
  /// but for an individual series. Overrides the chart wide configuration.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.pointDescriptionFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.pointInterval
  ...
  /// interval of the axis ticks, which is independent.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.pointIntervalUnit
  ...
  /// charts.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.pointPlacement
  ...
  /// value.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.pointStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.relativeXValue
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.selected
  ...
  /// whole series group.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.shadow
  ...
  /// the `selected` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.showCheckbox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.showInLegend
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.dumbbell.showInNavigator
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.skipKeyboardNavigation
  ...
  /// at 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.softThreshold

  bool? softThreshold;

  /// Sonification/audio chart options for a series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.sonification
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.stack
  ...
  /// `center` and `right`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.step
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.turboThreshold

  double? turboThreshold;

  /// Set the initial visibility of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.visible
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.xAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.yAxis

  dynamic yAxis;

  /// Define the visual z index of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.zIndex

  double? zIndex;

  /// Defines the Axis on which the zones are applied.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.zoneAxis
  ...
  /// (view live demo).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.zones
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.zoomEnabled
