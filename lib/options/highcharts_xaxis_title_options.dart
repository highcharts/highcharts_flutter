...
class HighchartsXAxisTitleOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/xAxis.title.align

  String? align;

  /// Deprecated. Set the `text` to `undefined` to disable the title.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/xAxis.title.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/xAxis.title.offset
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/xAxis.title.position3d

  String? position3d;

  /// Whether to reserve space for the title when laying out the axis.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/xAxis.title.reserveSpace
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/xAxis.title.rotation
  ...
  ///   set to `right`
  ///
  /// API Docs: https://api.highcharts.com/highcharts/xAxis.title.textAlign
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/xAxis.title.useHTML

  bool? useHTML;

  /// Horizontal pixel offset of the title position.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/xAxis.title.x

  double? x;

  /// Vertical pixel offset of the title position.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/xAxis.title.y
