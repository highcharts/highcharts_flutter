...
import 'highcharts_scatter_series_data_options.dart';
...
export 'highcharts_scatter_series_data_options.dart';
...
class HighchartsScatterSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.scatter.name
  String? name;

  /// Configuration options for the HighchartsScatterSeries.
  HighchartsScatterSeriesOptions? options;

  /// List of data point objects for the HighchartsScatterSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsScatterSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsScatterSeriesDataOptions>? dataPoints;
  @override
  get type => 'scatter';
