...
class HighchartsPointandfigureSeriesDataEventsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.data.events
  HighchartsPointandfigureSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
