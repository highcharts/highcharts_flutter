...
class HighchartsRenkoSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.renko.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.renko.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.renko.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.renko.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.renko.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.renko.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.renko.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.renko.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.renko.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.renko.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.renko.data.events
  HighchartsRenkoSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
