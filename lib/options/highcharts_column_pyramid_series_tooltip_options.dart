...
class HighchartsColumnPyramidSeriesTooltipOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.columnpyramid.tooltip.changeDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.dateTimeLabelFormats
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.headerFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.nullFormatter
  ...
  /// point color.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.pointFormat
  ...
  /// flexibility.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.pointFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.position
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.valueDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnpyramid.tooltip.xDateFormat

  String? xDateFormat;

  /// Highcharts Options Widget.
  HighchartsColumnPyramidSeriesTooltipOptions(
      {this.changeDecimals,
      this.clusterFormat,
