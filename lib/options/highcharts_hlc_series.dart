...
import 'highcharts_hlc_series_data_options.dart';
...
export 'highcharts_hlc_series_data_options.dart';
...
class HighchartsHLCSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsHLCSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsHLCSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsHLCSeriesDataOptions>? dataPoints;
  @override
  get type => 'hlc';
