...
class HighchartsAroonOscillatorSeriesTooltipOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.aroonoscillator.tooltip.changeDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.dateTimeLabelFormats

  HighchartsTooltipDateTimeLabelFormatsOptions? dateTimeLabelFormats;

  /// Distance from point to tooltip in pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.distance
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.headerFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.nullFormatter
  ...
  /// flexibility.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.pointFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.position

  HighchartsTooltipPositionOptions? position;

  /// Number of decimals in indicator series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.valueDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.aroonoscillator.tooltip.xDateFormat

  String? xDateFormat;

  /// Highcharts Options Widget.
  HighchartsAroonOscillatorSeriesTooltipOptions(
      {this.changeDecimals,
      this.clusterFormat,
