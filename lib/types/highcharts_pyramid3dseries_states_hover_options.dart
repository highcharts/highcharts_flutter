...
class HighchartsPyramid3DSeriesStatesHoverOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.states.hover.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.states.hover.borderColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.states.hover.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid3d.states.hover.enabled
