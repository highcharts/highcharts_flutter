...
class HighchartsVariwideSeriesStatesSelectOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.states.select.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variwide.states.select
  HighchartsVariwideSeriesStatesSelectOptions(
