...
class HighchartsBarSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.data.events
  HighchartsBarSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
