...
class HighchartsBubbleSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.data.events
  HighchartsBubbleSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
