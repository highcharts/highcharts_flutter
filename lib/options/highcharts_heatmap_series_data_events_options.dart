...
class HighchartsHeatmapSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heatmap.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heatmap.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heatmap.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heatmap.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heatmap.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heatmap.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heatmap.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heatmap.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heatmap.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heatmap.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.heatmap.data.events
  HighchartsHeatmapSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
