...
import 'highcharts_pie_series_states_hover_options.dart';
...
export 'highcharts_pie_series_states_hover_options.dart';
...
class HighchartsPieSeriesStatesOptions extends HighchartsOptionsBase {
  /// Highcharts Options Widget.
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.states.inactive
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.states.normal
  ...
  /// or programmatically.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.states.select
