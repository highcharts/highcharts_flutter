...
class HighchartsIKHSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ikh.name
  String? name;

  /// Configuration options for the HighchartsIKHSeries.
  HighchartsIKHSeriesOptions? options;

  /// List of data point objects for the HighchartsIKHSeries series.
  ///
