...
class HighchartsLinearregressionslopeSeriesTooltipOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.linearregressionslope.tooltip.changeDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.dateTimeLabelFormats

  HighchartsTooltipDateTimeLabelFormatsOptions? dateTimeLabelFormats;

  /// Distance from point to tooltip in pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.distance
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.headerFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.nullFormatter
  ...
  /// point color.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.pointFormat
  ...
  /// flexibility.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.pointFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.position
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.linearregressionslope.tooltip.xDateFormat

  String? xDateFormat;

  /// Highcharts Options Widget.
  HighchartsLinearregressionslopeSeriesTooltipOptions(
      {this.changeDecimals,
      this.clusterFormat,
