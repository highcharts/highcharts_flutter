...
class HighchartsTreemapSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.data.events
  HighchartsTreemapSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
