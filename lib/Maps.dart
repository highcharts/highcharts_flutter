...
class MapsOptions extends OptionFragment {
  ...
  */
  MapNavigationOptions? m_mapNavigation;

  MapNavigationOptions get mapNavigation { 
    if (this.m_mapNavigation == null) {
      this.m_mapNavigation = MapNavigationOptions();
    }
    return this.m_mapNavigation!;
  }

  void set mapNavigation (MapNavigationOptions v) {
    this.m_mapNavigation = v;
  }
  ...
  */
  MapViewOptions? m_mapView;

  MapViewOptions get mapView { 
    if (this.m_mapView == null) {
      this.m_mapView = MapViewOptions();
    }
  ...
  */
  MapsProductSeries? m_plotOptions;

  MapsProductSeries get plotOptions { 
    if (this.m_plotOptions == null) {
      this.m_plotOptions = MapsProductSeries();
    }
  ...
  */
  ...
  void toJSONInner(StringBuffer buffer) {
    ...
    if (this.m_mapNavigation != null) {  
      buffer.writeAll(["\"mapNavigation\":", this.m_mapNavigation?.toJSON(), ","], "");
    }

    if (this.m_mapView != null) {  
      buffer.writeAll(["\"mapView\":", this.m_mapView?.toJSON(), ","], "");
    }
