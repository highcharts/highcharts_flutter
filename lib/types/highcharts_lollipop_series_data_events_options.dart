...
class HighchartsLollipopSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.lollipop.data.events.update
