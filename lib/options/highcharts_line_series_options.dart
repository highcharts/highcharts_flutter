...
class HighchartsLineSeriesOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.allowPointSelect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.animationLimit

  double? animationLimit;

  /// Sets the color blending in the boost module.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.boostBlending
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.boostThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.clip
  ...
  /// `className` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.colorAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.colorIndex
  ...
  /// is set to `'sum'`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.colorKey
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.compare
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.compareBase
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.compareStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.connectEnds
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.connectNulls
  ...
  /// is rendered blurry.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.crisp
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.cropThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.cumulative
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.cumulativeStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.cursor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.custom
  ...
  /// series.color.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.dashStyle
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.dataGrouping
  ...
  /// (see example).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.dataLabels

  List<HighchartsSeriesDataLabelsOptions>? dataLabels;

  /// Options for the series data sorting.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.dataSorting
  ...
  /// about the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.description
  ...
  /// point.drop.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.dragDrop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.enableMouseTracking
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.findNearestPointBy
  ...
  /// weekends.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.gapSize
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.gapUnit
  ...
  /// series only.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.getExtremesFromAll
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.id
  ...
  /// with large datasets.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.inactiveOtherPoints
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.includeInDataExport
  ...
  /// legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.index
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.keys
  ...
  /// `graph` or an `area`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.label

  HighchartsSeriesLabelOptions? label;

  /// The line marks the last price from all points.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.lastPrice

  HighchartsSeriesLastPriceOptions? lastPrice;

  /// The line marks the last price from visible range of points.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.lastVisiblePrice

  HighchartsSeriesLastVisiblePriceOptions? lastVisiblePrice;

  /// The sequential index of the series in the legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.legendIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.legendSymbol
  ...
  /// styled mode.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.legendSymbolColor

  String? legendSymbolColor;

  /// Pixel width of the graph line.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.lineWidth
  ...
  /// bends.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.linecap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.linkedTo
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.marker
  ...
  /// defined both places.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.navigatorOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.negativeColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.nullInteraction
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.onPoint

  HighchartsSeriesOnPointOptions? onPoint;

  /// Opacity of a series parts: line, fill (e.g. area) and dataLabels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.opacity

  double? opacity;

  /// Properties for each single point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.point
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.pointDescriptionFormat
  ...
  /// but for an individual series. Overrides the chart wide configuration.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.pointDescriptionFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.pointInterval
  ...
  /// interval of the axis ticks, which is independent.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.pointIntervalUnit
  ...
  /// charts.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.pointPlacement
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.pointRange
  ...
  /// value.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.pointStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.relativeXValue
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.selected
  ...
  /// whole series group.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.shadow
  ...
  /// the `selected` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.showCheckbox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.showInLegend
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.showInNavigator
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.skipKeyboardNavigation
  ...
  /// at 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.softThreshold

  bool? softThreshold;

  /// Sonification/audio chart options for a series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.sonification
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.stack
  ...
  /// series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.stacking
  ...
  /// `center` and `right`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.step
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.stickyTracking
  ...
  /// negativeColor.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.threshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.tooltip
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.turboThreshold
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.line.useOhlcData

  bool? useOhlcData;

  /// Set the initial visibility of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.visible
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.xAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.yAxis

  dynamic yAxis;

  /// Define the visual z index of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.zIndex

  double? zIndex;

  /// Defines the Axis on which the zones are applied.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.zoneAxis
  ...
  /// (view live demo).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.zones
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.zoomEnabled
