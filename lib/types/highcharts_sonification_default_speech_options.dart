...
class HighchartsSonificationDefaultSpeechOptions extends HighchartsOptionsBase {
  ...
  /// language tag.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/sonification.defaultSpeechOptions.language
  ...
  /// synthesis.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/sonification.defaultSpeechOptions.preferredVoice
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/sonification.defaultSpeechOptions.type
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/sonification.defaultSpeechOptions.showPlayMarker
