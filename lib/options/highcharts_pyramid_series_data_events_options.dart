...
class HighchartsPyramidSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pyramid.data.events
  HighchartsPyramidSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
