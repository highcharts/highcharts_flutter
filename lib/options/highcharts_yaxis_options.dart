...
class HighchartsYAxisOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.alignTicks
  ...
  /// scale axes.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.allowDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.alternateGridColor
  ...
  /// polar).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.angle
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.ceiling
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.crossing
  ...
  /// Defaults to:
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.dateTimeLabelFormats
  ...
  /// either `y` or `xy`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.endOnTick

  bool? endOnTick;

  /// Event handlers for the axis.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.events

  HighchartsXAxisEventsOptions? events;

  /// The lowest allowed value for automatically computed axis extremes.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.floor
  ...
  /// class.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.gridLineColor
  ...
  /// this demonstration.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.gridLineDashStyle
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.gridLineInterpolation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.gridZIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.height
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.id
  ...
  /// left.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.left
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.lineColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.linkedTo
  ...
  /// horizontal axes.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.margin
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.maxColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/yAxis.maxLength
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.maxPadding
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.maxZoom
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minColor
  ...
  /// of plot area or pixel size.
  ///
  /// API Docs: https://api.highcharts.com/highstock/yAxis.minLength
  ...
  /// apply unless `softThreshold` is set to false.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minPadding
  ...
  /// are computed.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minRange
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minTickInterval
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minorGridLineColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minorGridLineDashStyle
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minorGridLineWidth

  double? minorGridLineWidth;

  /// Color for the minor tick marks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minorTickColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minorTickInterval

  String? minorTickInterval;

  /// The pixel length of the minor tick marks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minorTickLength
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minorTickWidth
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minorTicks
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.minorTicksPerMajor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.offset
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/yAxis.opposite
  ...
  /// will be used.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.pane
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.panningEnabled
  ...
  /// can be set.
  ///
  /// API Docs: https://api.highcharts.com/highstock/yAxis.range
  ...
  /// to the origin.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.reversed
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.reversedStacks
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.showEmpty

  bool? showEmpty;

  /// Whether to show the first tick label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.showFirstLabel

  bool? showFirstLabel;

  /// Whether to show the last tick label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.showLastLabel
  ...
  /// option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.softMax
  ...
  /// option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.softMin
  ...
  ///  0 = Sunday, 1 = Monday.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.startOfWeek
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.startOnTick
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.tickAmount
  ...
  /// class.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.tickColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.tickInterval

  double? tickInterval;

  /// The pixel length of the main tick marks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.tickLength
  ...
  /// Can be one of `inside` and `outside`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.tickPosition
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.tickPositioner
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.tickPositions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.tickWidth
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.tickmarkPlacement
  ...
  ///    used
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.tooltipValueFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.top
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.type
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.uniqueNames
  ...
  /// Defaults to:
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.units
  ...
  /// be visible.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.visible
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.width

  dynamic width;

  /// The Z index for the axis group.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.zIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/yAxis.zoomEnabled
