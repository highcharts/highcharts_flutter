...
class HighchartsVariablePieSeriesOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.allowPointSelect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.animation
  ...
  /// class.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.borderColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.center
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.className
  ...
  /// `className` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.colorAxis
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.colorIndex
  ...
  /// is set to `'sum'`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.colorKey
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.colors
  ...
  /// is rendered blurry.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.crisp
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.cursor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.custom
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.depth
  ...
  /// about the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.enableMouseTracking
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.fillColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.id
  ...
  /// 3.0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.ignoreHiddenPoint
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.includeInDataExport
  ...
  /// legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.index
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.innerSize
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.keys

  List<String>? keys;

  /// The sequential index of the series in the legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.legendIndex
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.legendSymbol
  ...
  /// styled mode.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.legendSymbolColor
  ...
  /// bends.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.linecap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.maxPointSize
  ...
  /// If a number is set, it applies in pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.minPointSize
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.minSize
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.nullInteraction
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.onPoint

  HighchartsSeriesOnPointOptions? onPoint;

  /// Opacity of a series parts: line, fill (e.g. area) and dataLabels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.opacity
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.pointDescriptionFormat
  ...
  /// but for an individual series. Overrides the chart wide configuration.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.pointDescriptionFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.relativeXValue
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.selected
  ...
  /// whole series group.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.shadow
  ...
  /// the `selected` option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.showCheckbox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.size
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.skipKeyboardNavigation
  ...
  /// should it be moved?.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.slicedOffset

  double? slicedOffset;

  /// Sonification/audio chart options for a series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.sonification
  ...
  /// right.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.startAngle
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.stickyTracking
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.thickness
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.visible

  bool? visible;

  /// Define the visual z index of the series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.zIndex
