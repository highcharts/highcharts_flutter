...
class HighchartsWindbarbSeriesTooltipOptions extends HighchartsOptionsBase {
  /// How many decimals to show for the `point.change`
  /// or the `point.cumulativeSum` value when the `series.compare`
  /// or the `series.cumulative` option is set.
  /// This is overridable in each series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.windbarb.tooltip.changeDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.dateTimeLabelFormats
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.headerFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.pointFormat
  ...
  /// flexibility.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.pointFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.position
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.valueDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.tooltip.xDateFormat

  String? xDateFormat;

  /// Highcharts Options Widget.
  HighchartsWindbarbSeriesTooltipOptions(
      {this.changeDecimals,
      this.clusterFormat,
