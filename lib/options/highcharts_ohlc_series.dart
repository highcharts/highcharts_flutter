...
import 'highcharts_ohlc_series_data_options.dart';
...
export 'highcharts_ohlc_series_data_options.dart';
...
class HighchartsOHLCSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ohlc.name
  String? name;

  /// Configuration options for the HighchartsOHLCSeries.
  HighchartsOHLCSeriesOptions? options;

  /// List of data point objects for the HighchartsOHLCSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsOHLCSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsOHLCSeriesDataOptions>? dataPoints;
  @override
  get type => 'ohlc';
