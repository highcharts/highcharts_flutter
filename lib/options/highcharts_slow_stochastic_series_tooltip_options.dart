...
class HighchartsSlowStochasticSeriesTooltipOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.slowstochastic.tooltip.changeDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.dateTimeLabelFormats

  HighchartsTooltipDateTimeLabelFormatsOptions? dateTimeLabelFormats;

  /// Distance from point to tooltip in pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.distance
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.headerFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.nullFormatter
  ...
  /// flexibility.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.pointFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.position

  HighchartsTooltipPositionOptions? position;

  /// Number of decimals in indicator series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.valueDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.slowstochastic.tooltip.xDateFormat

  String? xDateFormat;

  /// Highcharts Options Widget.
  HighchartsSlowStochasticSeriesTooltipOptions(
      {this.changeDecimals,
      this.clusterFormat,
