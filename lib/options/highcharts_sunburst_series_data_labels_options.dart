...
import 'highcharts_sunburst_series_data_labels_style_options.dart';
...
export 'highcharts_sunburst_series_data_labels_style_options.dart';
...
class HighchartsSunburstSeriesDataLabelsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.alignTo
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.backgroundColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.borderColor

  String? borderColor;

  /// The border radius in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.borderRadius

  double? borderRadius;

  /// The border width in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.borderWidth
  ...
  /// shadow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.connectorColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.connectorPadding
  ...
  /// the example).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.connectorShape
  ...
  /// `.highcharts-data-label-connector` class.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.connectorWidth
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.crookDistance
  ...
  /// option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.crop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.distance
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.filter
  ...
  /// `formatter`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.formatter
  ...
  /// points, like `pie`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.overflow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.padding
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.position
  ...
  /// rotated data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.rotation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.rotationMode
  ...
  /// and `width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.shadow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.shape
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.softConnector

  bool? softConnector;

  /// Highcharts Options Widget.

  HighchartsSunburstSeriesDataLabelsStyleOptions? style;
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.textPath
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.useHTML
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.verticalAlign
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.x
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.y
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.dataLabels.zIndex
