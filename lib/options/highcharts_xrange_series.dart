...
import 'highcharts_xrange_series_data_options.dart';
...
export 'highcharts_xrange_series_data_options.dart';
...
/// {@category series}
class HighchartsXRangeSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.xrange.name
  String? name;

  /// Configuration options for the HighchartsXRangeSeries.
  HighchartsXRangeSeriesOptions? options;

  /// List of data point objects for the HighchartsXRangeSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsXRangeSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsXRangeSeriesDataOptions>? dataPoints;
  @override
  get type => 'xrange';
