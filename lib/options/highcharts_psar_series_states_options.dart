...
import 'highcharts_psar_series_states_hover_options.dart';
...
export 'highcharts_psar_series_states_hover_options.dart';
...
class HighchartsPSARSeriesStatesOptions extends HighchartsOptionsBase {
  /// Highcharts Options Widget.
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.psar.states.inactive
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.psar.states.normal
  ...
  /// or programmatically.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.psar.states.select
