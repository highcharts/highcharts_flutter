...
///    available.
///
/// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data
class HighchartsErrorBarSeriesDataOptions extends HighchartsOptionsBase {
  /// Accessibility options for a data point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.className
  ...
  /// `colorIndex`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.colorIndex
  ...
  /// callbacks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.custom
  ...
  /// about the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.events

  HighchartsErrorBarSeriesDataEventsOptions? events;

  /// The high or maximum value for each data point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.high
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.id
  ...
  /// will be drawn.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.labelrank

  double? labelrank;

  /// The low or minimum value for each data point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.low

  double? low;

  /// The name of the point as shown in the legend, tooltip, dataLabels, etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.name

  String? name;

  /// Whether the data point is selected initially.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.selected
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.errorbar.data.x
