...
class HighchartsBoxPlotSeriesDragDropOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.dragMaxX

  dynamic dragMaxX;

  /// Set the maximum Y value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.dragMaxY

  double? dragMaxY;

  /// Set the minimum X value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.dragMinX

  dynamic dragMinX;

  /// Set the minimum Y value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.dragMinY
  ...
  /// `1`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.dragPrecisionX
  ...
  /// `1`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.dragPrecisionY
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.draggableHigh

  bool? draggableHigh;

  /// Allow low value to be dragged individually.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.draggableLow

  bool? draggableLow;

  /// Allow Q1 value to be dragged individually.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.draggableQ1

  bool? draggableQ1;

  /// Allow Q3 value to be dragged individually.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.draggableQ3

  bool? draggableQ3;

  /// Enable dragging in the X dimension.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.draggableX
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.draggableY
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.groupBy
  ...
  /// the `default` state.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.guideBox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.boxplot.dragDrop.liveRedraw
