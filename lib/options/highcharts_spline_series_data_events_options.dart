...
class HighchartsSplineSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.spline.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.spline.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.spline.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.spline.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.spline.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.spline.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.spline.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.spline.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.spline.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.spline.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.spline.data.events
  HighchartsSplineSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
