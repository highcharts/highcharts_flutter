...
class HighchartsMapLineSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mapline.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mapline.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mapline.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mapline.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mapline.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mapline.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mapline.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mapline.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mapline.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mapline.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.mapline.data.events
  HighchartsMapLineSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
