...
import 'highcharts_candlestick_series_data_options.dart';
...
export 'highcharts_candlestick_series_data_options.dart';
...
class HighchartsCandlestickSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsCandlestickSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsCandlestickSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsCandlestickSeriesDataOptions>? dataPoints;
  @override
