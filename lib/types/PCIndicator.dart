...
class PCIndicator extends OptionFragment {
  ...
  void toJSONInner(StringBuffer buffer) {
    ...
    // NOTE: skip serialization of pointArrayMap (type (keyof PCPoint)[] is ignored) ignore type: true

    // NOTE: skip serialization of pointClass (type typeof PCPoint is ignored) ignore type: true
