...
class HighchartsPolygonSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.polygon.data.events
  HighchartsPolygonSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
