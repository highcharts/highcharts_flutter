...
class HighchartsColumnRangeSeriesDragDropDragHandleOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnrange.dragDrop.dragHandle.className

  String? className;

  /// The fill color of the drag handles.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnrange.dragDrop.dragHandle.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnrange.dragDrop.dragHandle.cursor

  String? cursor;

  /// The line color of the drag handles.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnrange.dragDrop.dragHandle.lineColor

  String? lineColor;

  /// The line width for the drag handles.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnrange.dragDrop.dragHandle.lineWidth
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnrange.dragDrop.dragHandle.pathFormatter

  dynamic pathFormatter;

  /// The z index for the drag handles.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.columnrange.dragDrop.dragHandle.zIndex
