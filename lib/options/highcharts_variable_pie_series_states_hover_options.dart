...
class HighchartsVariablePieSeriesStatesHoverOptions
  ...
  /// class.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.states.hover.brightness

  double? brightness;

  /// Animation setting for hovering the graph in line-type series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.states.hover.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.states.hover.enabled
  ...
  /// `.highcharts-color-{n}`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.states.hover.halo
