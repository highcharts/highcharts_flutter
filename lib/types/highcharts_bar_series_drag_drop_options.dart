...
import 'highcharts_bar_series_drag_drop_drag_handle_options.dart';
...
export 'highcharts_bar_series_drag_drop_drag_handle_options.dart';
...
class HighchartsBarSeriesDragDropOptions extends HighchartsOptionsBase {
  /// Options for the drag handles available in column series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.dragHandle

  HighchartsBarSeriesDragDropDragHandleOptions? dragHandle;

  /// Set the maximum X value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.dragMaxX

  dynamic dragMaxX;

  /// Set the maximum Y value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.dragMaxY

  double? dragMaxY;

  /// Set the minimum X value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.dragMinX

  dynamic dragMinX;

  /// Set the minimum Y value the points can be moved to.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.dragMinY
  ...
  /// `1`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.dragPrecisionX
  ...
  /// `1`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.dragPrecisionY
  ...
  /// selecting points.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.dragSensitivity

  double? dragSensitivity;

  /// Enable dragging in the X dimension.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.draggableX
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.draggableY
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.groupBy
  ...
  /// the `default` state.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.guideBox
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.dragDrop.liveRedraw

  bool? liveRedraw;

  /// Highcharts Options Widget.
  HighchartsBarSeriesDragDropOptions(
      {this.dragHandle,
      this.dragMaxX,
      this.dragMaxY,
      this.dragMinX,
