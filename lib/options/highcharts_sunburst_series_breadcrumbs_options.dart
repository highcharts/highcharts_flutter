...
class HighchartsSunburstSeriesBreadcrumbsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.buttonSpacing
  ...
  /// states.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.buttonTheme
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.floating
  ...
  /// options.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.format

  String? format;

  /// Callback function to format the breadcrumb text from scratch.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.formatter
  ...
  /// properties.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.position
  ...
  /// `spacingBox`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.relativeTo
  ...
  /// and Hebrew.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.rtl

  bool? rtl;

  /// Options object for Breadcrumbs separator.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.separator

  HighchartsNavigationBreadcrumbsSeparatorOptions? separator;

  /// Show full path or only a single button.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.showFullPath
  ...
  /// different states.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.style

  dynamic style;

  /// Whether to use HTML to render the breadcrumbs items texts.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.useHTML

  bool? useHTML;

  /// The z index of the breadcrumbs group.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sunburst.breadcrumbs.zIndex
