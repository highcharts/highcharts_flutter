...
class HighchartsPieSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pie.data.events
  HighchartsPieSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
