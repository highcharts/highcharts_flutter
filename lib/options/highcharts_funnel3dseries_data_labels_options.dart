...
class HighchartsFunnel3DSeriesDataLabelsOptions extends HighchartsOptionsBase {
  /// Highcharts Options Widget.
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.alignTo
  ...
  /// can be set to 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.allowOverlap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.backgroundColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.borderColor

  String? borderColor;

  /// The border radius in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.borderRadius

  double? borderRadius;

  /// The border width in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.borderWidth
  ...
  /// shadow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.defer

  bool? defer;

  /// Enable or disable the data labels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.filter
  ...
  /// `formatter`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.format
  ...
  /// ignored.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.formatter
  ...
  /// points, like `pie`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.padding
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.position
  ...
  /// rotated data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.rotation
  ...
  /// and `width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.shadow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.shape
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.style
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.textPath
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.useHTML
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.x
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.y
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel3d.dataLabels.zIndex

  double? zIndex;

  /// Highcharts Options Widget.
  HighchartsFunnel3DSeriesDataLabelsOptions(
      {this.align,
      this.alignTo,
      this.allowOverlap,
      this.animation,
