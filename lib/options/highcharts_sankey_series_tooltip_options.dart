...
class HighchartsSankeySeriesTooltipOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.dateTimeLabelFormats
  ...
  /// the item.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.format
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.nodeFormat
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.position
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.valueDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.sankey.tooltip.xDateFormat

  String? xDateFormat;

  /// Highcharts Options Widget.
  HighchartsSankeySeriesTooltipOptions(
      {this.clusterFormat,
