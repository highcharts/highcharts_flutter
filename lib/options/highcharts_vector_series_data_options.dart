...
class HighchartsVectorSeriesDataOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.className
  ...
  /// `colorIndex`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.colorIndex
  ...
  /// callbacks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.custom
  ...
  /// about the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.description

  String? description;

  /// The vector direction in degrees, where 0 is north (pointing towards south).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.direction
  ...
  /// on `series.dragDrop`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.dragDrop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.drilldown

  String? drilldown;

  /// The individual point events.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.id
  ...
  /// will be drawn.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.labelrank
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.length

  double? length;

  /// Options for the point markers of line-like series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.marker

  HighchartsVectorSeriesDataMarkerOptions? marker;

  /// The name of the point as shown in the legend, tooltip, dataLabels, etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.name

  String? name;

  /// Whether the data point is selected initially.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.selected
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.x

  dynamic x;

  /// The y value of the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.y

  double? y;

  /// An array of data points for the series. For the `vector` series type, points can be given in the following ways:
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data
