...
import 'highcharts_treegraph_series_data_labels_link_text_path_options.dart';
import 'highcharts_treegraph_series_data_labels_style_options.dart';
...
export 'highcharts_treegraph_series_data_labels_link_text_path_options.dart';
export 'highcharts_treegraph_series_data_labels_style_options.dart';
...
class HighchartsTreegraphSeriesDataLabelsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.align
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.alignTo
  ...
  /// can be set to 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.allowOverlap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.backgroundColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.borderColor

  String? borderColor;

  /// The border radius in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.borderRadius

  double? borderRadius;

  /// The border width in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.borderWidth
  ...
  /// shadow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.color
  ...
  /// option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.crop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.filter
  ...
  /// `formatter`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.format
  ...
  /// ignored.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.formatter
  ...
  /// inside.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.headers
  ...
  /// points, like `pie`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.overflow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.position
  ...
  /// rotated data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.rotation
  ...
  /// and `width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.shadow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.shape
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.textPath
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.useHTML
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.x
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.y
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treegraph.dataLabels.zIndex
