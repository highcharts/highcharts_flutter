...
class HighchartsCandlestickSeriesDataEventsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.candlestick.data.events
  HighchartsCandlestickSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
