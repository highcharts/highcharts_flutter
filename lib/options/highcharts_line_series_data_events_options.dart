...
class HighchartsLineSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.line.data.events
  HighchartsLineSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
