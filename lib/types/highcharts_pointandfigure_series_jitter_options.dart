...
class HighchartsPointandfigureSeriesJitterOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.jitter.x

  double? x;

  /// The maximal Y offset for the random jitter effect.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.jitter.y
