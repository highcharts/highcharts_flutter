...
import 'highcharts_treegraph_series_data_options.dart';
...
export 'highcharts_treegraph_series_data_options.dart';
...
class HighchartsTreegraphSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsTreegraphSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsTreegraphSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsTreegraphSeriesDataOptions>? dataPoints;
  @override
  get type => 'treegraph';
