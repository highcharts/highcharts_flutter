...
import 'highcharts_vector_series_states_hover_options.dart';
...
export 'highcharts_vector_series_states_hover_options.dart';
...
class HighchartsVectorSeriesStatesOptions extends HighchartsOptionsBase {
  /// Highcharts Options Widget.

  HighchartsVectorSeriesStatesHoverOptions? hover;

  /// The opposite state of a hover for series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.states.inactive
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.states.normal
  ...
  /// or programmatically.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.states.select

  HighchartsSeriesStatesSelectOptions? select;

  /// Highcharts Options Widget.
  HighchartsVectorSeriesStatesOptions(
