...
class HighchartsColumnSeriesDataOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.accessibility
  ...
  /// rule.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.borderColor
  ...
  /// `colorIndex`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.colorIndex
  ...
  /// callbacks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.custom
  ...
  /// about the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.drilldown

  String? drilldown;

  /// The individual point events.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.id
  ...
  /// will be drawn.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.labelrank

  double? labelrank;

  /// The name of the point as shown in the legend, tooltip, dataLabels, etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.name
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.selected
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.x

  dynamic x;

  /// The y value of the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.column.data.y
