...
import 'highcharts_treemap_series_data_options.dart';
...
export 'highcharts_treemap_series_data_options.dart';
...
class HighchartsTreemapSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.treemap.name
  String? name;

  /// Configuration options for the HighchartsTreemapSeries.
  HighchartsTreemapSeriesOptions? options;

  /// List of data point objects for the HighchartsTreemapSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsTreemapSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsTreemapSeriesDataOptions>? dataPoints;
  @override
  get type => 'treemap';
