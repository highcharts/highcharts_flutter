...
class HighchartsADSeries extends HighchartsSeries {
  /// Highcharts Options Widget.
  List<List<dynamic>>? data;

  /// The name of the series as shown in the legend, tooltip etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ad.name
  String? name;

  /// Configuration options for the HighchartsADSeries.
  HighchartsADSeriesOptions? options;

  /// List of data point objects for the HighchartsADSeries series.
  ///
