...
class HighchartsWindbarbSeriesStatesSelectOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.states.select.enabled
