...
class HighchartsDrilldownBreadcrumbsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/drilldown.breadcrumbs.buttonSpacing
  ...
  /// states.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/drilldown.breadcrumbs.buttonTheme
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/drilldown.breadcrumbs.floating
  ...
  /// options.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/drilldown.breadcrumbs.format
  ...
  /// properties.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/drilldown.breadcrumbs.position
  ...
  /// `spacingBox`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/drilldown.breadcrumbs.relativeTo
  ...
  /// and Hebrew.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/drilldown.breadcrumbs.rtl

  bool? rtl;

  /// Options object for Breadcrumbs separator.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/drilldown.breadcrumbs.separator

  HighchartsNavigationBreadcrumbsSeparatorOptions? separator;

  /// Show full path or only a single button.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/drilldown.breadcrumbs.showFullPath
  ...
  /// different states.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/drilldown.breadcrumbs.style

  dynamic style;

  /// Whether to use HTML to render the breadcrumbs items texts.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/drilldown.breadcrumbs.useHTML

  bool? useHTML;

  /// The z index of the breadcrumbs group.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/drilldown.breadcrumbs.zIndex
