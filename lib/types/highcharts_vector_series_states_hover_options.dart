...
class HighchartsVectorSeriesStatesHoverOptions extends HighchartsOptionsBase {
  ...
  /// hovered.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.states.hover.lineWidthPlus

  double? lineWidthPlus;

  /// Animation setting for hovering the graph in line-type series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.states.hover.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.states.hover.enabled
  ...
  /// `.highcharts-color-{n}`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.states.hover.halo
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.states.hover.lineWidth
  ...
  /// marker.states.hover.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.states.hover.marker
