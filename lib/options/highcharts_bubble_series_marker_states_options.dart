...
class HighchartsBubbleSeriesMarkerStatesOptions extends HighchartsOptionsBase {
  ...
  /// from hover.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.marker.states.normal
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bubble.marker.states.select
