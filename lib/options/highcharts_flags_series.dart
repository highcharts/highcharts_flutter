...
import 'highcharts_flags_series_data_options.dart';
...
export 'highcharts_flags_series_data_options.dart';
...
class HighchartsFlagsSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.name
  String? name;

  /// Configuration options for the HighchartsFlagsSeries.
  HighchartsFlagsSeriesOptions? options;

  /// List of data point objects for the HighchartsFlagsSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsFlagsSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsFlagsSeriesDataOptions>? dataPoints;
  @override
  get type => 'flags';
