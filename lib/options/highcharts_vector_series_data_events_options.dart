...
class HighchartsVectorSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.vector.data.events
  HighchartsVectorSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
