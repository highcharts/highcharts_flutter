...
class HighchartsSonificationDefaultSpeechMappingTimeOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/sonification.defaultSpeechOptions.mapping.time.mapFunction
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/sonification.defaultSpeechOptions.mapping.time.mapTo
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/sonification.defaultSpeechOptions.mapping.time.max
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/sonification.defaultSpeechOptions.mapping.time.min
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/sonification.defaultSpeechOptions.mapping.time.value
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/sonification.defaultSpeechOptions.mapping.time.within
