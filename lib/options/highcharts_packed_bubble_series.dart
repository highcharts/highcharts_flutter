...
import 'highcharts_packed_bubble_series_data_options.dart';
...
export 'highcharts_packed_bubble_series_data_options.dart';
...
class HighchartsPackedBubbleSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsPackedBubbleSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsPackedBubbleSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsPackedBubbleSeriesDataOptions>? dataPoints;
  @override
