...
///
/// API Docs: https://api.highcharts.com/highcharts/series.flags.states.select
class HighchartsFlagsSeriesStatesSelectOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.flags.states.select.enabled
