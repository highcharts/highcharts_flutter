...
class HighchartsVennSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.venn.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.venn.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.venn.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.venn.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.venn.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.venn.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.venn.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.venn.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.venn.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.venn.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.venn.data.events
  HighchartsVennSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
