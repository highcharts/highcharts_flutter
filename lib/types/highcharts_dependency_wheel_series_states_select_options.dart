...
class HighchartsDependencyWheelSeriesStatesSelectOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.states.select.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dependencywheel.states.select
  HighchartsDependencyWheelSeriesStatesSelectOptions(
