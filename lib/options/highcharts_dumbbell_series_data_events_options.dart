...
class HighchartsDumbbellSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.dumbbell.data.events
  HighchartsDumbbellSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
