...
import 'highcharts_networkgraph_series_data_options.dart';
...
export 'highcharts_networkgraph_series_data_options.dart';
...
class HighchartsNetworkgraphSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.networkgraph.name
  String? name;

  /// Configuration options for the HighchartsNetworkgraphSeries.
  HighchartsNetworkgraphSeriesOptions? options;

  /// List of data point objects for the HighchartsNetworkgraphSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsNetworkgraphSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsNetworkgraphSeriesDataOptions>? dataPoints;
  @override
