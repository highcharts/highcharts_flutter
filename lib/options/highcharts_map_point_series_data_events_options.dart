...
class HighchartsMapPointSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mappoint.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mappoint.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mappoint.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mappoint.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mappoint.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mappoint.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mappoint.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mappoint.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mappoint.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mappoint.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.mappoint.data.events
  HighchartsMapPointSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
