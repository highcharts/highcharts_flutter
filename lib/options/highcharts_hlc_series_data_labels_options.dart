...
class HighchartsHLCSeriesDataLabelsOptions extends HighchartsOptionsBase {
  /// Highcharts Options Widget.
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.alignTo
  ...
  /// can be set to 0.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.allowOverlap
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.animation
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.backgroundColor
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.borderColor

  String? borderColor;

  /// The border radius in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.borderRadius

  double? borderRadius;

  /// The border width in pixels for the data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.borderWidth
  ...
  /// shadow.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.className
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.color
  ...
  /// option.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.crop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.defer

  bool? defer;

  /// Enable or disable the data labels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.enabled
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.filter
  ...
  /// `formatter`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.format
  ...
  /// ignored.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.formatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.inside
  ...
  /// points, like `pie`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.nullFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.overflow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.padding
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.position
  ...
  /// rotated data label.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.rotation
  ...
  /// and `width`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.shadow
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.shape
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.style
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.textPath
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.useHTML
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.x
  ...
  /// pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.y
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hlc.dataLabels.zIndex

  double? zIndex;

  /// Highcharts Options Widget.
  HighchartsHLCSeriesDataLabelsOptions(
      {this.align,
      this.alignTo,
      this.allowOverlap,
      this.animation,
