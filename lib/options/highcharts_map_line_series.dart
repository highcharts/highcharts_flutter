...
import 'highcharts_map_line_series_data_options.dart';
...
export 'highcharts_map_line_series_data_options.dart';
...
class HighchartsMapLineSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mapline.name
  String? name;

  /// Configuration options for the HighchartsMapLineSeries.
  HighchartsMapLineSeriesOptions? options;

  /// List of data point objects for the HighchartsMapLineSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsMapLineSeriesDataOptions class, which allows full configuration of each
