...
class HighchartsMapSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.map.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.map.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.map.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.map.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.map.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.map.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.map.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.map.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.map.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.map.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highmaps/series.map.data.events
  HighchartsMapSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
