...
import 'highcharts_bar_series_data_options.dart';
...
export 'highcharts_bar_series_data_options.dart';
...
class HighchartsBarSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.bar.name
  String? name;

  /// Configuration options for the HighchartsBarSeries.
  HighchartsBarSeriesOptions? options;

  /// List of data point objects for the HighchartsBarSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsBarSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsBarSeriesDataOptions>? dataPoints;
  @override
  get type => 'bar';
