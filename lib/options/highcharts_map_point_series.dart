...
import 'highcharts_map_point_series_data_options.dart';
...
export 'highcharts_map_point_series_data_options.dart';
...
class HighchartsMapPointSeries extends HighchartsSeries {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.mappoint.name
  String? name;

  /// Configuration options for the HighchartsMapPointSeries.
  HighchartsMapPointSeriesOptions? options;

  /// List of data point objects for the HighchartsMapPointSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsMapPointSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsMapPointSeriesDataOptions>? dataPoints;
  @override
  get type => 'mappoint';
