...
class HighchartsFunnelSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.events
  HighchartsFunnelSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
