...
import 'highcharts_variable_pie_series_states_hover_options.dart';
...
export 'highcharts_variable_pie_series_states_hover_options.dart';
...
class HighchartsVariablePieSeriesStatesOptions extends HighchartsOptionsBase {
  /// Highcharts Options Widget.
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.states.inactive
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.states.normal
  ...
  /// or programmatically.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.variablepie.states.select
