...
///    available.
///
/// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data
class HighchartsWindbarbSeriesDataOptions extends HighchartsOptionsBase {
  /// Accessibility options for a data point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.className
  ...
  /// `colorIndex`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.colorIndex
  ...
  /// callbacks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.custom
  ...
  /// about the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.description

  String? description;

  /// The wind direction in degrees, where 0 is north (pointing towards south).
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.direction
  ...
  /// on `series.dragDrop`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.dragDrop
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.drilldown

  String? drilldown;

  /// The individual point events.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.id
  ...
  /// will be drawn.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.labelrank

  double? labelrank;

  /// Options for the point markers of line-like series.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.marker

  HighchartsWindbarbSeriesDataMarkerOptions? marker;

  /// The name of the point as shown in the legend, tooltip, dataLabels, etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.name

  String? name;

  /// Whether the data point is selected initially.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.selected

  bool? selected;

  /// The wind speed in meters per second.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.value
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.x

  dynamic x;

  /// The y value of the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data.y

  double? y;

  /// An array of data points for the series. For the `windbarb` series type, points can be given in the following ways:
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.windbarb.data
