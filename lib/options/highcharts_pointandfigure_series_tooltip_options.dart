...
class HighchartsPointandfigureSeriesTooltipOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highstock/series.pointandfigure.tooltip.changeDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.clusterFormat
  ...
  /// dateFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.dateTimeLabelFormats

  HighchartsTooltipDateTimeLabelFormatsOptions? dateTimeLabelFormats;

  /// Distance from point to tooltip in pixels.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.distance
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.followPointer
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.followTouchMove

  bool? followTouchMove;

  /// A string to append to the tooltip format.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.footerFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.format
  ...
  /// to pointFormat.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.nullFormat
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.nullFormatter
  ...
  /// flexibility.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.pointFormatter
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.position
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.valueDecimals
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.valuePrefix
  ...
  /// series' tooltip options object.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.valueSuffix
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pointandfigure.tooltip.xDateFormat

  String? xDateFormat;

  /// Highcharts Options Widget.
  HighchartsPointandfigureSeriesTooltipOptions(
      {this.changeDecimals,
      this.clusterFormat,
