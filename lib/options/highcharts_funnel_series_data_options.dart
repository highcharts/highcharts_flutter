...
class HighchartsFunnelSeriesDataOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.accessibility
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.className
  ...
  /// `colorIndex`.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.colorIndex
  ...
  /// callbacks.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.custom
  ...
  /// about the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.description
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.drilldown

  String? drilldown;

  /// The individual point events.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.events
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.id
  ...
  /// will be drawn.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.labelrank

  double? labelrank;

  /// The sequential index of the data point in the legend.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.legendIndex

  double? legendIndex;

  /// The name of the point as shown in the legend, tooltip, dataLabels, etc.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.name

  String? name;

  /// Whether the data point is selected initially.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.selected

  bool? selected;

  /// The y value of the point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.funnel.data.y
