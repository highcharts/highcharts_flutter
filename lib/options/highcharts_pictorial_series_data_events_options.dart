...
class HighchartsPictorialSeriesDataEventsOptions extends HighchartsOptionsBase {
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pictorial.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pictorial.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pictorial.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pictorial.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pictorial.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pictorial.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pictorial.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pictorial.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pictorial.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pictorial.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.pictorial.data.events
  HighchartsPictorialSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
