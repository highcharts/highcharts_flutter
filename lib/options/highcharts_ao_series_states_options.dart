...
import 'highcharts_ao_series_states_hover_options.dart';
...
export 'highcharts_ao_series_states_hover_options.dart';
...
class HighchartsAOSeriesStatesOptions extends HighchartsOptionsBase {
  /// Highcharts Options Widget.
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ao.states.inactive
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ao.states.normal
  ...
  /// or programmatically.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.ao.states.select
