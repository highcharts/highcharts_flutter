...
///
/// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.states.select
class HighchartsHollowcandlestickSeriesStatesSelectOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.states.select.borderColor

  String? borderColor;

  /// A specific color for the selected point.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.states.select.color
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.hollowcandlestick.states.select.enabled
