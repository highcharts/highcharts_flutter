...
class HighchartsPackedBubbleSeriesDataEventsOptions
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.data.events.click
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.data.events.drag
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.data.events.dragStart
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.data.events.drop
  ...
  /// event information.
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.data.events.mouseOut
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.data.events.mouseOver
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.data.events.remove
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.data.events.select
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.data.events.unselect
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.data.events.update
  ...
  ///
  /// API Docs: https://api.highcharts.com/highcharts/series.packedbubble.data.events
  HighchartsPackedBubbleSeriesDataEventsOptions(
      {this.click,
      this.drag,
      this.dragStart,
      this.drop,
