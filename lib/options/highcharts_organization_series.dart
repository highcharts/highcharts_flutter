...
import 'highcharts_organization_series_data_options.dart';
...
export 'highcharts_organization_series_data_options.dart';
...
class HighchartsOrganizationSeries extends HighchartsSeries {
  ...
  /// List of data point objects for the HighchartsOrganizationSeries series.
  ///
  /// Use this property to define individual data points using the
  /// HighchartsOrganizationSeriesDataOptions class, which allows full configuration of each
  ...
  List<HighchartsOrganizationSeriesDataOptions>? dataPoints;
  @override
